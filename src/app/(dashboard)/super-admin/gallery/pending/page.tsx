...
const PENDING = [
    { id: 1, src: 'https://images.unsplash.com/photo-1543353071-873f17a7a088?w=500&h=500&fit=crop', event: 'Dance Comp', user: 'Pro Cam 2', time: '10m ago' },
    { id: 2, src: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=500&h=500&fit=crop', event: 'Crowd Cheering', user: 'Student Cam', time: '12m ago' },
     { id: 3, src: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?w=500&h=500&fit=crop', event: 'Code Marathon', user: 'Volunter', time: '15m ago' },
];
        ...
        <div className="p-6 md:p-8 max-w-[1600px] mx-auto">
             <div className="flex flex-col gap-4 mb-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-[#1A1A1A]">Pending Approvals</h1>
                        <p className="text-sm text-[#6B7280]">Review user uploads before they go public.</p>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {PENDING.map((item: any) => (
                    <div key={item.id} className="bg-white rounded-[18px] border border-[#E5E7EB] overflow-hidden shadow-sm flex flex-col group">
