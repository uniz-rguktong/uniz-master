        ...
        <div className="p-8 animate-page-entrance">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-2 text-sm text-[#6B7280] mb-3">
                    ...
                    <span>Settings</span>
                    <span>›</span>
                    <span className="text-[#1A1A1A] font-medium">Organization Settings</span>
                </div>

                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-[28px] font-semibold text-[#1A1A1A] mb-2">Sports Settings</h1>
                        <p className="text-sm text-[#6B7280]">Configure sports council details and institutional information</p>
                    </div>
