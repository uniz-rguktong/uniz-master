...
export function DocumentationPage() {
    ...
    const docs = [
        ...
        // --- Outreach & Reports ---
        {
            ...
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Migrate data seamlessly. Use 'Bulk Import' to bring in historical volunteer lists or donor records. Use 'Export' to generate detailed reports in Excel format for offline analysis or institutional submissions.</p>
                </div>
            ),
            questions: [
