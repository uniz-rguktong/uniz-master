...
export function ContactUsPage() {
    ...
    const handleSubmit = (e: any) => {
        ...
        setTimeout(() => {
            ...
            showToast("Message sent to HHO Technical Team! We will contact you soon.", "success");
            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-[#6B7280]">Technical support for Helping Hands Organization dashboard.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                                ...
                                {isLoading ? (
                                    ...
                                    <>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                <label className="text-sm font-medium text-[#1A1A1A]">HHO Email</label>
                                                <input
                                                    required
                                                    type="email"
                                                    placeholder="Ex: hho-admin@university.edu"
                                                    className="w-full px-4 py-2.5 bg-white border border-[#E5E7EB] rounded-xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:border-transparent transition-all"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Select value={subject} onValueChange={setSubject}>
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="volunteer_issue">Volunteer Data Issue</SelectItem>
                                                    <SelectItem value="event_approval">Event Approval System</SelectItem>
                                                    <SelectItem value="donation_report">Donation Reports Bug</SelectItem>
                                                    <SelectItem value="general">General Tech Support</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </div>

                                        <div className="space-y-2">
                                            <label className="text-sm font-medium text-[#1A1A1A]">Issue Description</label>
                                            <textarea
                                                required
                                                rows={6}
                ...
                <div className="lg:col-span-4 space-y-6">
                    {isLoading ? (
                        ...
                        [
                            { icon: Mail, label: "Tech Support Email", value: "tech@hho-dashboard.com", sub: "Response time: ~4 hours", color: "text-[#3B82F6]", bg: "bg-blue-50" },
                            { icon: Phone, label: "Emergency Helpline", value: "+1 (555) 000-9999", sub: "For critical system failures", color: "text-[#10B981]", bg: "bg-emerald-50" },
                            { icon: MapPin, label: "Admin Office", value: "Student Center, Room 204", sub: "University Campus", color: "text-[#F59E0B]", bg: "bg-amber-50" }
                        ].map((item: any, i: any) => (
