...
const teams = [
  {
    ...
    members: [
      { id: '1', name: 'John Smith', studentId: 'CSE2021001', year: 'III', section: 'A', role: 'Captain', phoneNumber: '+91 98765 43210' },
      { id: '2', name: 'Mike Johnson', studentId: 'CSE2021002', year: 'III', section: 'A', role: 'Vice Captain', phoneNumber: '+91 98765 43211' },
      { id: '3', name: 'David Lee', studentId: 'CSE2021003', year: 'III', section: 'B', role: 'Member', phoneNumber: '+91 98765 43212' },
      { id: '4', name: 'Tom Wilson', studentId: 'CSE2021004', year: 'II', section: 'A', role: 'Member', phoneNumber: '+91 98765 43213' },
      { id: '5', name: 'Chris Brown', studentId: 'CSE2021005', year: 'II', section: 'B', role: 'Member', phoneNumber: '+91 98765 43214' }]

  },
  {
    id: 2,
    teamName: 'Hoop Masters',
    sport: 'Basketball',
    sportColor: '#F59E0B',
    captain: 'Sarah Johnson',
    viceCaptain: 'Emma Davis',
    yearLevel: 'III & IV Year',
    status: 'pending',
    registeredDate: '2025-10-20',
    members: [
      { id: '1', name: 'Sarah Johnson', studentId: 'CSE2020015', year: 'IV', section: 'A', role: 'Captain', phoneNumber: '+91 98765 43220' },
      { id: '2', name: 'Emma Davis', studentId: 'CSE2020016', year: 'IV', section: 'A', role: 'Vice Captain', phoneNumber: '+91 98765 43221' },
      { id: '3', name: 'Olivia Martin', studentId: 'CSE2021017', year: 'III', section: 'B', role: 'Member', phoneNumber: '+91 98765 43222' },
      { id: '4', name: 'Sophia Garcia', studentId: 'CSE2021018', year: 'III', section: 'A', role: 'Member', phoneNumber: '+91 98765 43223' },
      { id: '5', name: 'Ava Martinez', studentId: 'CSE2020019', year: 'IV', section: 'B', role: 'Member', phoneNumber: '+91 98765 43224' }]

  },
  {
    id: 3,
    teamName: 'Goal Crushers',
    sport: 'Football',
    sportColor: '#10B981',
    captain: 'Michael Chen',
    viceCaptain: 'Ryan Patel',
    yearLevel: 'II Year',
    status: 'approved',
    registeredDate: '2025-10-18',
    members: [
      { id: '1', name: 'Michael Chen', studentId: 'CSE2022030', year: 'II', section: 'A', role: 'Captain', phoneNumber: '+91 98765 43230' },
      { id: '2', name: 'Ryan Patel', studentId: 'CSE2022031', year: 'II', section: 'A', role: 'Vice Captain', phoneNumber: '+91 98765 43231' },
      { id: '3', name: 'Arjun Kumar', studentId: 'CSE2022032', year: 'II', section: 'B', role: 'Member', phoneNumber: '+91 98765 43232' },
      { id: '4', name: 'Rohan Sharma', studentId: 'CSE2022033', year: 'II', section: 'A', role: 'Member', phoneNumber: '+91 98765 43233' },
      { id: '5', name: 'Karthik Reddy', studentId: 'CSE2022034', year: 'II', section: 'B', role: 'Member', phoneNumber: '+91 98765 43234' }]
...
export function TeamRegistrationPage({ onNavigate }: TeamRegistrationPageProps = {}) {
  ...
  const sports = ['All', 'Cricket', 'Basketball', 'Football', 'Volleyball', 'Badminton'];
  ...
  const handleRegisterTeam = () => {
    ...
    if (editingId) {
      ...
      setTeamsList(teamsList.map(team =>
        team.id === editingId
          ? {
            ...
            teamName,
            sport: selectedSport,
            // Update sportColor based on new sport if needed, simplified here
            members: teamMembers,
            captain: teamMembers.find(m => m.role === 'Captain').name,
            viceCaptain: teamMembers.find(m => m.role === 'Vice Captain').name,
            // keeping other fields like yearLevel, registeredDate as is or update logic can be added
          }
          : team
      ));
      ...
      const newTeam = {
        ...
        teamName,
        sport: selectedSport,
        sportColor: '#3B82F6', // Default color for new teams
        captain: teamMembers.find(m => m.role === 'Captain').name,
        viceCaptain: teamMembers.find(m => m.role === 'Vice Captain').name,
        yearLevel: 'Mixed', // Default
        status: 'pending',
                      ...
                      <thead className="bg-[#F9FAFB] border-b border-[#E5E7EB]">
                        <tr>
                          {['Name', 'ID', 'Year', 'Sec', 'Role', 'Phone', ''].map(h => (
                            <th key={h} className="px-4 py-2.5 text-left text-xs font-bold text-[#6B7280] uppercase tracking-wider">{h}</th>
                          ))}
                        </tr>
                      </thead>
