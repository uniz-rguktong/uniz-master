        ...
        <div className="p-8 animate-page-entrance">
            <div className="mb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h1 className="text-[28px] font-semibold text-[#1A1A1A] mb-2">{config.title || 'Event Calendar'}</h1>
                    ...
                    <div className="flex items-center gap-1 bg-white border border-[#E5E7EB] rounded-xl p-1">
                        {(['month', 'week', 'list'] as CalendarViewType[]).map((view: any) => (
                            <button
                                ...
                                className={`px-6 py-2 rounded-lg text-sm font-semibold transition-all capitalize ${viewType === view ? 'bg-[#1A1A1A] text-white shadow-md' : 'text-[#6B7280] hover:bg-[#F7F8FA]'
                                    }`}
                            >
                                {view}
                            </button>
