...
import { X, Calendar, Clock, MapPin, Users, Info, Settings, Trash2 } from 'lucide-react';
...
export function EventDetailsPanel({ event, onClose, onEdit, onDelete }: EventDetailsPanelProps) {
    ...
    return (
        <>
            <div
                ...
                onClick={onClose}
            />
            <div className={`fixed inset-y-0 right-0 w-full sm:w-[400px] bg-white shadow-2xl z-[100] transform transition-transform duration-300 ease-in-out border-l border-[#E5E7EB] ${event ? 'translate-x-0' : 'translate-x-full'}`}>
                {event && (
                    <div className="h-full flex flex-col">
                        <div className="p-6 border-b border-[#E5E7EB] flex items-start justify-between bg-[#F9FAFB]">
                            <div>
                                <h2 className="text-xl font-bold text-[#1A1A1A] mb-1">{event.title}</h2>
                                <span
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-8">
                            <section className="space-y-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-semibold text-[#1A1A1A]">Date</h4>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-semibold text-[#1A1A1A]">Time</h4>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-semibold text-[#1A1A1A]">Venue</h4>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 className="text-sm font-semibold text-[#1A1A1A]">Attendance</h4>
                                        <p className="text-sm text-[#4B5563]">{event.registrations} / {event.capacity} registered</p>
                                    </div>
                                </div>
                            </section>
