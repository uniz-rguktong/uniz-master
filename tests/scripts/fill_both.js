...
async function run() {
  try {
    ...
    const attRes = await axios.get(
      "https://uniz.rguktong.in/api/v1/academics/attendance/template?branch=CSE&year=E2&semesterId=SEM-1",
      {
    ...
    const grdRes = await axios.get(
      "https://uniz.rguktong.in/api/v1/academics/grades/template?branch=CSE&year=E2&semesterId=SEM-1",
      {
        headers: { Authorization: `Bearer ${TOKEN}` },
        responseType: "arraybuffer",
      },
    ...
    await w1.xlsx.writeFile(
      "/Users/sreecharandesu/Projects/uniz-master/attendance_filled.xlsx",
    );
    ...
    await w2.xlsx.writeFile(
      "/Users/sreecharandesu/Projects/uniz-master/final_grades_filled.xlsx",
    );
