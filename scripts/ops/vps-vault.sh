...
REMOTE_VAULT_SCRIPT="/root/uniz-master-main/scripts/ops/vps-vault-remote.sh"
LOCAL_REMOTE_SCRIPT="$ROOT/scripts/ops/vps-vault-remote.sh"

usage() {
  cat <<EOF
Usage: ./scripts/ops/vps-vault.sh <command> [args]
