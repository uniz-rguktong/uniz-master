...
function sync_local_envs() {
    ...
    APPS=(
        "uniz-portal:VITE_API_URL,VITE_MAINTENANCE_MODE,VITE_CLOUDINARY_CLOUD_NAME=CLOUDINARY_CLOUD_NAME,VITE_CLOUDINARY_UPLOAD_PRESET=CLOUDINARY_UPLOAD_PRESET,VITE_SCRAPER_URL"
        "uniz-auth:JWT_SECURITY_KEY,DATABASE_URL=AUTH_DATABASE_URL,REDIS_URL,INTERNAL_SECRET,USER_SERVICE_URL,GATEWAY_URL,EMAIL_USER,EMAIL_PASS"
        ...
        "ornate-ems:DATABASE_URL=ORNATE_DATABASE_URL,DIRECT_URL=ORNATE_DIRECT_URL,NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY,NEXTAUTH_URL,NEXTAUTH_SECRET,R2_ACCOUNT_ID,R2_ENDPOINT,R2_BUCKET_NAME,R2_ACCESS_KEY_ID,R2_SECRET_ACCESS_KEY,R2_PUBLIC_DOMAIN,UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN,AWS_REGION,AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY,SES_FROM_EMAIL"
    )
