...
function sync_local_envs() {
    ...
    APPS=(
        ...
        "ornate:DATABASE_URL=ORNATE_DATABASE_URL,DIRECT_URL=ORNATE_DIRECT_URL,NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY,NEXTAUTH_URL=ORNATE_LANDING_NEXTAUTH_URL,NEXTAUTH_SECRET,email_user=ORNATE_LANDING_EMAIL_USER,email_pass=ORNATE_LANDING_EMAIL_PASS,R2_ACCOUNT_ID,R2_ENDPOINT,R2_BUCKET_NAME,R2_ACCESS_KEY_ID,R2_SECRET_ACCESS_KEY,R2_PUBLIC_DOMAIN,NEXT_PUBLIC_ASSETS_URL,UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN,AWS_REGION,AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY,SES_FROM_EMAIL"
    )
