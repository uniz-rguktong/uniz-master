...
info "UniZ setup — see docs/local/LOCAL_SETUP.md for details"
info ""
...
if [ "$missing" -eq 1 ]; then
  ...
  info "  https://github.com/uniz-rguktong/uniz-master/blob/main/docs/local/LOCAL_SETUP.md#prerequisites"
  exit 1
fi
...
bash ./scripts/local/setup-local.sh
...
info "Login:   webadmin / password123  (after seeding)"
info ""
info "Troubleshooting: docs/local/LOCAL_SETUP.md"
