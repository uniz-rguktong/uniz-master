    ...
    return [
      {
        ...
        headers: [
          ...
          // and WebGL via Three.js (worker-src blob: for Three.js internals).
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.jsdelivr.net", // jsdelivr for UnicornStudio SDK
              ...
              "connect-src 'self' blob: https://*.unicorn.studio https://cdn.jsdelivr.net https://*.cloudfront.net https://grainy-gradients.vercel.app https://cdjpdrsqbwkbfnhbzlet.supabase.co",
