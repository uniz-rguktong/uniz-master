...
const META_CACHE_NAME = "ornate-push-meta";
...
self.addEventListener("notificationclick", (event) => {
  ...
  const targetUrl = event.notification?.data?.url || "/home/updates";
  ...
  event.waitUntil(
    (async () => {
      try {
        ...
        const vapidPublicKey = keyResult?.publicKey;
