...
export const metadata: Metadata = {
  ...
  description: 'Join the ultimate spacefest journey. A revolutionary college festival experience beyond the stars.',
  keywords: ['college fest', 'ornate', 'spacefest', 'techfest', 'cultural fest', 'events space', 'student festival'],
  openGraph: {
    title: 'Ornate | Witness the Gallons of Zeal',
    description: 'Join the ultimate spacefest journey. A revolutionary college festival experience beyond the stars.',
    type: 'website',
