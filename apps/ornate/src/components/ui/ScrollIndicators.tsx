...
export default function ScrollIndicators() {
    ...
    return (
        <div className="scroll-indicator-root fixed right-4 sm:right-8 bottom-4 sm:bottom-8 z-[2000] pointer-events-none flex flex-col items-end opacity-90 transition-all duration-300">
            <span
