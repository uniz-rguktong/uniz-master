...
export default function MissionsFooter() {
    return (
        <footer className="w-full border-t border-white/10 bg-black/40 backdrop-blur-md pt-16 pb-8 px-12 relative z-10 mt-20">
            {/* Top Glow Bar */}
            ...
            <div className="mt-12 pt-10 border-t border-white/5 items-center text-center relative z-20">
                <div className="flex flex-col items-center gap-2 mb-8">
                    <p className="text-[10px] font-black tracking-[0.3em] uppercase text-white/30">Ornate 2K26 Galactic Command</p>
                    <h4 className="text-[13px] font-black tracking-[0.2em] uppercase text-[var(--color-neon)]">RGUKT IIIT ONGOLE</h4>
                    <p className="text-[9px] font-bold text-gray-600 tracking-[0.15em] uppercase px-4 max-w-sm">IIIT ONGOLE, PRAKASAM DISTRICT, AP - 523225</p>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] font-bold tracking-[0.3em] text-gray-600 uppercase">
                    <p>&copy; 2026 ORNATE GALACTIC COMMAND. ALL OVERRIDES SECURED.</p>
