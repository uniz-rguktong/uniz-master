...
<Steps>
  <Step title="Request an OTP">
    On the sign-in page, click **Forgot password** and enter your username. UniZ sends a one-time password to your registered email.
  </Step>
  <Step title="Verify the OTP">
    Enter the six-digit OTP from your email on the verification screen.
  </Step>
  <Step title="Set a new password">
    Enter and confirm your new password. You are then redirected to the sign-in page.
  </Step>
</Steps>

<Warning>
  OTPs expire after a short window. If you do not receive an email within a few minutes, check your spam folder or contact your system administrator.
</Warning>
