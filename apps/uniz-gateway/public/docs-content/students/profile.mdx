...
<Steps>
  <Step title="Tap the edit icon">
    On the profile header, tap the pencil icon next to your name, or use the **Edit** button (desktop: top-right corner).
  </Step>
  <Step title="Modify the fields you want to change">
    Only changed fields are sent to the server — unchanged fields are left as-is.
  </Step>
  <Step title="Tap Save">
    On desktop, tap **Save** in the top-right corner. On mobile, tap **Save Changes** at the bottom of the editing panel.
  </Step>
</Steps>
...
<Note>
Academic fields — your roll number, year, branch, section, and room number — are managed by the administration and cannot be edited from the portal.
</Note>
...
<Steps>
  ...
  <Step title="Select a photo">
    Choose an image from your device. Accepted formats are standard image types (JPEG, PNG, etc.).
  </Step>
  <Step title="Wait for upload">
    The photo is uploaded to cloud storage and your profile URL is updated automatically. You'll see a loading spinner while it uploads.
  </Step>
</Steps>

<Tip>
Use a clear, recent photo — it may be used for identification purposes in campus records.
</Tip>
...
<Info>
For urgent matters — such as a rejected leave request you believe is incorrect, or a discrepancy in your academic record — contact your caretaker, warden, or academic section directly rather than waiting for a grievance response.
</Info>
