...
<CardGroup cols={2}>
  <Card title="Student" icon="graduation-cap" href="/students/login">
    ...
    **You can:**
    ...
    - **Register semester subjects** when registration is open (Register tab)
  ...
  <Card title="SWO" icon="user-check" href="/admin/approvals">
    ...
    **You can:**
    ...
    - **View and resolve student grievances** (with email notification to verified students)
  ...
  <Card title="HOD" icon="user-graduate" href="/admin/semester-registration">
    Head of Department — department-scoped academic access.

    **You can:**
    - View **read-only** student profiles in your department only
    - Review and edit elective allocations during `HOD_REVIEW`
    - Track semester registration completion for your branch
    - Export/search students within your department

    **You cannot:**
    - View students outside your department
    - Delete students or change roles
    - Give final outpass approval (unless also assigned dean/director)
...
<Card title="Webadmin" icon="wrench" href="/admin/overview">
...
- **Build semesters**, open registration, and track enrollment
- Manage technical configurations
- Monitor real-time system health across all UniZ services

The webadmin role is the only role that can control what announcements the entire user base sees.
