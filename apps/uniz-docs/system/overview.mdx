...
<CardGroup cols={2}>
  <Card title="Production topology" icon="server" href="/system/topology">
    Hosts, parked Deployments, HPA matrix.
  </Card>
  <Card title="Request flow" icon="route" href="/system/request-flow">
    Exact path of one API call through Traefik and gateway.
  </Card>
  <Card title="Gateway service" icon="share-nodes" href="/services/gateway">
    serviceMap, cache, health aggregate.
  </Card>
  <Card title="Search index" icon="magnifying-glass" href="/search-index">
    Keyword table for “how was X implemented?”.
  </Card>
</CardGroup>
