...
UniZ manages **in-portal semester registration**. Webadmins configure a semester and subject catalog; deans and HODs review allocations; students register subjects during an IST registration window; administrators track completion per student.
...
**Auth required:** Webadmin, Dean, HOD, Director, COE
...
Creates a semester with subjects and elective groups. Webadmin only.
...
When publishing results or opening registration, webadmins may need email OTP verification:
...
**Auth required:** Webadmin, Dean, Director, COE, HOD (HOD scoped to own department)
