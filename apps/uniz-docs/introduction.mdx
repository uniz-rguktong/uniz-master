...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Install the PWA and sign in.
  </Card>
  <Card title="Roles" icon="users" href="/roles">
    What each campus role can do.
  </Card>
  <Card title="Architecture" icon="sitemap" href="/system/overview">
    Full Mermaid topology.
  </Card>
  <Card title="Gateway map" icon="route" href="/api/platform/gateway">
