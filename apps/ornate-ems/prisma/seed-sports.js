...
async function main() {
  ...
  const mainSportsAdminPayload = {
    ...
    notificationSettings: JSON.parse(
      '{"securityAlerts": true, "tournamentUpdates": true, "systemAnnouncements": false, "registrationSummaries": false}',
    ),
    preferences: JSON.parse(
      '{"darkMode": false, "language": "English (International)", "timezone": "Asia/Kolkata", "compactView": false, "passkeyEnabled": false, "advancedProtection": true}',
    ),
  };
