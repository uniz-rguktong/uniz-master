...
const notificationCategories = [
  {
    ...
    description:
      "Alerts for charity drives, volunteer ops, and donation milestones.",
    accent: "bg-indigo-50 text-indigo-600 border-indigo-100",
    settings: [
      {
        id: "drive_created",
        label: "New charity drive launched",
        email: true,
        push: true,
        sms: false,
      },
      ...
      },
      {
        ...
        label: "Significant donation milestone",
        email: true,
        push: false,
        sms: false,
      },
      {
        id: "vols_approved",
        label: "Volunteer group approvals",
        email: true,
        push: true,
        sms: true,
      },
...

  {
    ...
    settings: [
      ...
      {
        id: "backup_completed",
        label: "Impact data backup success",
        email: true,
        push: false,
        sms: false,
      },
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Manage HHO notification preferences and delivery channels
            </p>
          </div>
