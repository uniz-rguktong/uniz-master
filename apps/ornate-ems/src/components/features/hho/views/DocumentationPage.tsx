...
export function DocumentationPage() {
    ...
    const docs = [
        // --- Platform Basics ---
        {
            ...
            description: "Understanding the core layout and real-time metrics on your organization's home screen.",
            category: "Platform Basics",
            readTime: "2 min",
            icon: Home,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>The HHO Dashboard provides a command center for all organization activities:</p>
                    <ul className="list-disc pl-5 space-y-2">
                        <li><strong>Live Metrics:</strong> Real-time counts of active volunteers, ongoing drives, and total beneficiaries reached.</li>
                        <li><strong>Impact Charts:</strong> Visual breakdowns of donation trends, volunteer hours logged, and event completion rates.</li>
                        <li><strong>Activity Feed:</strong> A timeline of the most recent volunteer check-ins, donation receipts, and event milestones.</li>
                    </ul>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Staying updated on organization events and configuring your communication alerts.",
            category: "Platform Basics",
            readTime: "3 min",
            icon: Bell,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Never miss a critical update. The Notification Pipeline aggregates alerts for new volunteer sign-ups, donation confirmations, and event status changes. Customize which notifications you receive via email or in-app push.</p>
                </div>
            ),
            questions: [
        ...
        // --- Event Management ---
        {
            ...
            description: "Step-by-step guide to planning and launching a new community service or fundraising event.",
            ...
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    ...
                    <ul className="list-disc pl-5 space-y-3">
                        <li><strong>Phase 1: Cause Definition:</strong> Define the cause, target beneficiaries, and fundraising goal.</li>
                        <li><strong>Phase 2: Logistics:</strong> Set dates, assign venues, and define volunteer requirements.</li>
                        <li><strong>Phase 3: Outreach:</strong> Create promotional material, upload posters, and share on social media.</li>
                        <li><strong>Phase 4: Registration:</strong> Open volunteer/participant registrations with approval workflows.</li>
                        <li><strong>Phase 5: Execution:</strong> Track live attendance, manage on-ground operations.</li>
                    </ul>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Organize pending events and manage your organization's historical event log.",
            category: "Event Management",
            readTime: "3 min",
            icon: FileText,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>The 'All Events' page allows you to filter through Ongoing, Upcoming, and Draft events. Use Drafts to finalize details before making drives visible to the volunteer network.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Visual calendar view for planning drives without conflicts.",
            category: "Event Management",
            readTime: "3 min",
            icon: Calendar,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Use the Event Calendar to plan your community drives. It highlights blocked dates (exams, university events) and shows overlapping drives to prevent volunteer fatigue. Color-coded tags help differentiate event types at a glance.</p>
                </div>
            ),
            questions: [
        ...
        // --- Volunteer Ops ---
        {
            ...
            description: "Managing volunteer sign-ups, verification, and role assignment.",
            ...
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        <li><strong>Registration:</strong> Volunteers sign up via the portal with student ID verification.</li>
                        <li><strong>Approval:</strong> Review pending applications and approve or reject based on eligibility.</li>
                        <li><strong>Role Assignment:</strong> Assign roles like Team Lead, Field Volunteer, or Logistics Coordinator.</li>
                        <li><strong>Hours Tracking:</strong> Log and verify volunteer hours for each event automatically.</li>
                    </ul>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Organizing volunteers into teams for field operations and large-scale drives.",
            category: "Volunteer Ops",
            readTime: "4 min",
            icon: Heart,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>For large-scale events, organize volunteers into teams. Each team can have a designated Team Lead who coordinates on-ground activities, tracks attendance, and reports outcomes back to the dashboard.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Real-time volunteer check-ins using QR scanning and manual logging.",
            category: "Volunteer Ops",
            readTime: "3 min",
            icon: ClipboardList,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Track volunteer attendance in real-time during events. Launch the 'Live Attendance' module, scan volunteer QR codes, or manually mark them. The system instantly updates your event participation rates and volunteer hours.</p>
                </div>
            ),
            questions: [
                "Does the scanner work spot?",
        ...
        // --- Donations & Funds ---
        {
            ...
            description: "Recording, verifying, and reporting all monetary and in-kind donations.",
            ...
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    ...
                    <ul className="list-disc pl-5 space-y-2">
                        <li><strong>Digital Receipts:</strong> Upload screenshots of UPI/bank transfers for verification.</li>
                        <li><strong>Cash Deposits:</strong> Record cash donations with the official deposit receipt.</li>
                        <li><strong>In-Kind Donations:</strong> Log non-monetary contributions like food, clothing, or supplies.</li>
                        <li><strong>Audit Trail:</strong> Every transaction is logged with timestamp and approver details.</li>
                    </ul>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Allocating collected funds to specific causes and tracking expenditure.",
            category: "Donations & Funds",
            readTime: "4 min",
            icon: HandHeart,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Ensure every rupee is accounted for. Use the fund allocation module to assign budgets to specific drives, track real-time expenditure, and generate transparent financial reports for stakeholders.</p>
                </div>
            ),
            questions: [
        ...
        // --- Team & Security ---
        {
            ...
            description: "Defining access levels for admins, coordinators, and volunteers.",
            ...
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                        <li><strong>HHO Admin:</strong> Full access to all settings, finance, and volunteer data.</li>
                        <li><strong>Event Coordinator:</strong> Can create events, manage registrations, and track attendance.</li>
                        <li><strong>Team Lead:</strong> Operational access to their assigned team and events only.</li>
                    </ul>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Onboarding new team members and managing their active roles.",
            category: "Team & Security",
            readTime: "3 min",
            icon: UserPlus,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Build your core leadership team from the 'Coordinator Management' page. Add new members, assign specific responsibilities, track their last login, and manage their access to the organization's data and modules.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Managing your credentials, profile picture, and session security.",
            category: "Team & Security",
            readTime: "2 min",
            icon: Settings,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Your Admin Profile is your identity on the HHO platform. Keep it updated with official contact details and a professional profile picture. Monitor active sessions to ensure account security.</p>
                </div>
            ),
            questions: [
        ...
        // --- Outreach & Reports ---
        {
            ...
            description: "Synchronizing volunteer and donor data via CSV/Excel for record-keeping.",
            category: "Outreach & Reports",
            readTime: "4 min",
            icon: FileJson,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Migrate data seamlessly. Use 'Bulk Import' to bring in historical volunteer lists or donor records. Use 'Export' to generate detailed reports in Excel format for spot analysis or institutional submissions.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Measuring community impact, volunteer engagement, and fundraising milestones.",
            category: "Outreach & Reports",
            readTime: "7 min",
            icon: TrendingUp,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Go beyond basic numbers. Analyze which departments contribute the most volunteers, track donation trends over semesters, and measure the real-world impact of your community service initiatives.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Broadcasting announcements to volunteers and donors about upcoming drives.",
            category: "Outreach & Reports",
            readTime: "3 min",
            icon: Megaphone,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Communicate instantly with your volunteer network. Use the 'Updates' module to send push notifications about upcoming drives, venue changes, or urgent volunteer requests.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Publishing drive results and recognizing outstanding volunteers.",
            category: "Outreach & Reports",
            readTime: "4 min",
            icon: Trophy,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Celebrate impact. Use the 'Event Outcomes' feature to publish drive results—beneficiaries reached, funds raised, and items distributed. Recognize outstanding volunteers publicly through the platform.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Customizing your organization's visual identity and promotional media.",
            category: "Outreach & Reports",
            readTime: "3 min",
            icon: Video,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Keep your branding consistent. Upload your official HHO logo and promotional videos that appear on event pages and volunteer portals. Manage these globally from the 'Promo Media' settings.</p>
                </div>
            ),
            questions: [
        ...
        },
        {
            ...
            description: "Showcasing event highlights and managing your organization's media heritage.",
            category: "Outreach & Reports",
            readTime: "4 min",
            icon: Image,
            content: (
                <div className="space-y-4 text-sm text-[#4B5563]">
                    <p>Tell your organization's story visually. The Gallery module lets you curate high-resolution photos from community drives, awareness campaigns, and team-building events—building a powerful legacy for future batches.</p>
                </div>
            ),
            questions: [
            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                        <h1 className="text-xl md:text-[28px] font-semibold text-[#1A1A1A] mb-1">Knowledge <span className="text-[#3B82F6]">Hub</span></h1>
                        <p className="text-sm text-[#6B7280]">Comprehensive guides for every module in your HHO Dashboard.</p>
                    </div>
                </div>
            </div>
