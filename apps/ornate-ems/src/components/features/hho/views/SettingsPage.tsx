        ...
        <div className="p-8 animate-page-entrance">
            ...
            <div className="mb-8">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-[28px] font-semibold text-[#1A1A1A] mb-2">HHO Settings</h1>
                        <p className="text-sm text-[#6B7280]">Configure organization details and contact information</p>
                    </div>

                    <button
                        onClick={handleSave}
                        disabled={!hasChanges || isLoading}
                        className={`flex items-center gap-2 px-5 py-3 rounded-lg text-sm font-medium transition-colors shadow-sm ${hasChanges && !isLoading
                    ...
                    <div className="bg-[#F4F2F0] rounded-[18px] p-[10px]">
                        ...
                        <div className="bg-white rounded-[14px] p-6 shadow-sm">
                            <div className="text-center">
                                ...
                                >
                                    {formData.logo ? (
                                        <img src={formData.logo} alt="HHO Logo" className="w-full h-full object-cover" />
                                    ) : (
                        ...
                        <div className="bg-white rounded-[14px] overflow-hidden shadow-sm border border-[#E5E7EB]">
                            <table className="w-full">
                                ...
                                <tbody className="divide-y divide-[#F3F4F6]">
                                    <tr>
                                        <td className="px-6 py-4 text-sm font-medium text-[#6B7280]">Active Volunteers</td>
                                        <td className="px-6 py-4 text-right text-sm font-bold text-[#1A1A1A]">{formData.stats.volunteers}</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 text-sm font-medium text-[#6B7280]">Events Conducted</td>
                                        <td className="px-6 py-4 text-right text-sm font-bold text-[#1A1A1A]">{formData.stats.events}</td>
                                    </tr>
                                    <tr>
                                        <td className="px-6 py-4 text-sm font-medium text-[#6B7280]">Funds Raised</td>
                                        <td className="px-6 py-4 text-right text-sm font-bold text-[#1A1A1A]">{formData.stats.fundsRaised}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
