...
export function ContactUsPage() {
  ...
  const handleSubmit = (e: any) => {
    ...
    setTimeout(() => {
      ...
      showToast(
        "Message sent to HHO Technical Team! We will contact you soon.",
        "success",
      );
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-[#6B7280]">
              Technical support for Helping Hands Organization dashboard.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={subject} onValueChange={setSubject}>
                        ...
                        <SelectContent>
                          <SelectItem value="volunteer_issue">
                            Volunteer Data Issue
                          </SelectItem>
                          <SelectItem value="event_approval">
                            Event Approval System
                          </SelectItem>
                          <SelectItem value="donation_report">
                            Donation Reports Bug
                          </SelectItem>
            ...
            [
              {
                ...
                value: "tech@hho-dashboard.com",
                sub: "Response time: ~4 hours",
                color: "text-[#3B82F6]",
                bg: "bg-blue-50",
              },
              {
                ...
                value: "+1 (555) 000-9999",
                sub: "For critical system failures",
                color: "text-[#10B981]",
                bg: "bg-emerald-50",
              },
              {
