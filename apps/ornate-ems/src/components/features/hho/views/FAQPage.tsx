...
export function FAQPage() {
    ...
    const categories = ["Common Questions", "Volunteering", "Donations", "Events"];

    const faqs = [
        {
            question: "How do I add a new volunteer manually?",
            answer: "Navigate to the 'Volunteers' section in the sidebar. Click on the 'Add Volunteer' button. You'll need to enter their basic details including name, student ID, and contact information.",
            category: "Volunteering"
        },
        {
            question: "How can I track donation history?",
            answer: "Go to the 'Donations' tab. You can filter donations by date, donor name, or campaign. You can also export the donation report as a CSV file for auditing.",
            category: "Donations"
        },
        {
            question: "How do I create a new charity drive?",
            answer: "Click on 'Create Event' from the dashboard. Select 'Charity Drive' as the event type. Fill in the details about the cause, target amount (if any), and volunteer requirements.",
            category: "Events"
        },
        {
            question: "Can I assign roles to volunteers?",
            answer: "Yes, within the 'Volunteers' management page, you can assign roles such as 'Team Lead', 'Field Volunteer', or 'Logistics Coordinator'. This helps in better event management.",
            category: "Volunteering"
        },
        {
            question: "How do I verify a donation receipt?",
            answer: "In the 'Pending Donations' section, you can view uploaded screenshots of payment receipts. Verify the transaction ID with your bank statement and click 'Approve'.",
            category: "Donations"
        },
        {
            question: "Who can access the HHO admin dashboard?",
            answer: "Only authorized student coordinators and faculty supervisors have access. You can manage access levels in the 'Settings' page under 'Team Management'.",
            category: "Common Questions"
        },
        {
            question: "How to specific volunteer hours for a student?",
            answer: "Go to the student's profile in the 'Volunteers' list. You can manually log hours for specific events or approve hours claimed by the volunteer.",
            category: "Volunteering"
        },
        {
            question: "Is there a limit to the number of events we can host?",
            answer: "There is no strict limit, but all events must be approved by the faculty advisor. Ensure you do not overlap with major university examinations or other major events.",
            category: "Common Questions"
        },
        {
            question: "How do I generate a certificate for volunteers?",
            answer: "After an event is marked as 'Completed', go to the event details. There is a 'Generate Certificates' option which will create bulk certificates for all attendees marked as 'Present'.",
            category: "Events"
        },
        {
            question: "How to handle cash donations?",
            answer: "Cash donations must be immediately deposited to the official HHO bank account. The receipt must be uploaded to the portal with the 'Cash Deposit' tag for transparency.",
            category: "Donations"
        }
    ];
            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                        <h1 className="text-2xl md:text-[28px] font-semibold text-[#1A1A1A] mb-2">Frequently Asked <span className="text-[#F59E0B]">Questions</span></h1>
                        <p className="text-sm text-[#6B7280]">Find answers to common questions about managing HHO operations.</p>
                    </div>
                </div>
            </div>
