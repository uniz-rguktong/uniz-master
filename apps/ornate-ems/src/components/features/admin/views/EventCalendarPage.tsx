...
export function EventCalendarPage() {
  ...
  const filteredEvents = events.filter((event: any) => {
    ...
    if (appliedFilters.startDate && event.date < appliedFilters.startDate)
      return false;
    if (appliedFilters.endDate && event.date > appliedFilters.endDate)
      return false;

    if (appliedFilters.venue && event.venue !== appliedFilters.venue)
      return false;
  ...
  return (
    <>
      <div className="p-4 md:p-8 animate-page-entrance">
        ...
        <div
          className="bg-[#F4F2F0] rounded-[16px] p-2 animate-card-entrance"
            ...
            <div className="flex items-center gap-2 bg-white border border-[#E5E7EB] rounded-lg p-1 w-full sm:w-auto justify-center">
              {["month", "week", "list"].map((view: any) => (
                <button
                  ...
                  className={`flex-1 sm:flex-initial px-4 py-2 rounded text-sm font-medium transition-colors capitalize ${
                    viewType === view
                      ? "bg-[#1A1A1A] text-white"
            ...
            <div className="p-4 md:p-8 space-y-4">
              {viewType === "month" ? (
                <div className="border border-[#E5E7EB] rounded-lg overflow-hidden">
                  ...
                  <div className="grid grid-cols-7">
                    {[...Array(35)].map((_: any, i: any) => (
                      <div
                        key={i}
                        className="min-h-[120px] border-r border-b border-[#E5E7EB] p-2"
                      >
                        <Skeleton
                          width={20}
                          height={20}
                ...
                [...Array(5)].map((_: any, i: any) => (
                  <div
                    key={i}
                    className="bg-[#F7F8FA] rounded-xl border border-[#E5E7EB] p-6 flex items-start gap-6"
                  >
                ...
                <div className="flex min-h-[600px] border border-[#E5E7EB] rounded-lg overflow-hidden">
                  <div className="w-20 border-r border-[#E5E7EB]">
                    ...
                    {[...Array(12)].map((_: any, i: any) => (
                      <div
                        key={i}
                        className="h-[60px] p-2 flex flex-col items-end"
                      >
                    ...
                    <div className="grid grid-cols-7">
                      ...
                      {Array.from({ length: daysInMonth }).map(
                        (_: any, index: any) => {
                          ...
                          const isToday =
                            day === 6 && month === 10 && year === 2025; // Highlighting Nov 6, 2025
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              onClick={() =>
                                router.push(
                                  `/branch-admin/events/create?id=${event.id}`,
                                )
                              }
                  ...
                  <div className="flex bg-white min-h-[600px] min-w-[800px] overflow-hidden">
                    ...
                    <div className="w-20 shrink-0 border-r border-[#E5E7EB]">
                      ...
                      {timeSlots.map((time: any) => (
                        <div
                          key={time}
                          className="h-[60px] text-xs text-[#6B7280] text-right pr-2 pt-2 relative"
                        >
                          <span className="relative z-10 bg-white pl-1">
                            {time}
                          </span>
                    ...
                    <div className="flex-1 grid grid-cols-7 overflow-x-auto">
                      {weekDays.map((day: any, i: any) => (
                        <div
                          key={i}
                          className="min-w-[120px] border-r border-[#E5E7EB] last:border-r-0 relative"
                        >
                          {/* Header */}
                          ...
                          <div className="relative h-[780px]">
                            ...
                            {timeSlots.map((_: any, index: any) => (
                              <div
                                key={index}
                                className="h-[60px] border-b border-[#E5E7EB] border-dashed"
                              ></div>
                            ))}
                            {/* Events */}
                            {filteredEvents
                              .filter(
                                (e) =>
                                  e.date === day.toISOString().split("T")[0],
                              )
                              .map((event) => (
                                <div
                                  key={event.id}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setTempFilters((prev: any) => ({ ...prev, venue: value }))
              }
            >
      ...
      <div
        className={`fixed inset-y-0 right-0 w-full sm:w-[400px] bg-white shadow-2xl transform transition-transform duration-300 ease-in-out z-100 ${
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="pt-6 border-t border-[#E5E7EB] grid grid-cols-2 gap-3">
                <button
                  onClick={() =>
                    router.push(
                      `/branch-admin/events/create?id=${selectedEvent.id}`,
                    )
                  }
