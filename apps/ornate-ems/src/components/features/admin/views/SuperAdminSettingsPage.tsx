...
export function SuperAdminSettingsPage() {
  ...
  const [formData, setFormData] = useState<any>({
    ...
    description:
      "Centralized control system for managing all university-level fests, departmental activities, and sports events. Ensuring seamless coordination across all administrative portals.",
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Manage institutional identity and global system parameters
            </p>
          </div>
          ...
          <div className="bg-[#F4F2F0] rounded-[18px] p-[10px]">
            ...
            <div className="bg-white rounded-[14px] p-6 shadow-sm">
              <div className="text-center">
                ...
                <div className="w-32 h-32 mx-auto mb-4 bg-linear-to-br from-purple-500 to-indigo-500 rounded-lg flex items-center justify-center border-2 border-transparent overflow-hidden relative shadow-inner">
                  {formData.logo ? (
                    <img
                      src={formData.logo}
                      alt="Global Logo"
                ...
                <tbody className="divide-y divide-[#F3F4F6]">
                  <tr>
                    ...
                    <td className="px-6 py-4 text-right text-sm font-bold text-[#1A1A1A]">
                      {formData.stats.totalUsers.toLocaleString()}
                    </td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 text-sm font-medium text-[#6B7280]">
