        ...
        <div className="p-4 md:p-8 bg-white">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <h1 className="text-xl md:text-[28px] font-semibold text-[#1A1A1A]">Events Management</h1>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex flex-col xl:flex-row items-stretch xl:items-center gap-3 w-full md:w-auto">
                {/* Top line on mobile: Archived & Draft Events */}
                <div className="flex flex-row items-center gap-2 overflow-x-auto pb-1 md:pb-0 scrollbar-hide md:w-auto w-full">
                  <button
                    onClick={() => {
                    ...
                    className={`flex-1 sm:flex-none shrink-0 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 border whitespace-nowrap ${showArchived
                  ...
                  <button
                    ...
                    className={`flex-1 sm:flex-none shrink-0 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium transition-all duration-200 border whitespace-nowrap ${showDrafts
                ...
                {/* Bottom line on mobile: Sort By & View Tools */}
                <div className="flex flex-row items-center gap-2 overflow-x-auto pb-1 md:pb-0 scrollbar-hide w-full sm:w-auto">
                  <div className="flex-1 sm:flex-none shrink-0 min-w-[150px]">
                    <Select value={sortBy} onValueChange={setSortBy}>
                      <SelectTrigger className="w-full xl:w-[160px] bg-white border border-[#E5E7EB] rounded-lg text-sm focus:ring-2 focus:ring-[#1A1A1A] transition-all">
                  ...
                  <div className="shrink-0 flex items-center justify-center gap-1 bg-white border border-[#E5E7EB] rounded-lg p-1 ml-auto sm:ml-0">
                    <button
