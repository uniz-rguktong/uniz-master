          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="animate-card-entrance" style={{ animationDelay: '80ms' }}>
                <MetricCard
                  title="Waitlisted Spot"
                  value={String(filteredSpot)}
                  icon={Users}
                  iconBgColor="#F5F3FF"
                  iconColor="#8B5CF6"
                  tooltip="Waitlisted manual/spot registrations (filtered)" />
              </div>
                  ...
                  <div className="flex-1 w-full text-center sm:text-left">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 mb-4">
                      ...
                      <div className="bg-[#F7F8FA] rounded-lg p-2 sm:p-3">
                        ...
                        <div className={`text-[10px] sm:text-xs ${registration.seatsAvailable > 0 ? 'text-[#10B981]' : 'text-[#EF4444]'}`}>
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                      <div className="grid grid-cols-2 gap-2 w-full sm:flex sm:w-auto sm:gap-3">
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto flex flex-row items-center justify-center gap-1 sm:gap-2 px-2 py-2 sm:px-4 bg-[#1A1A1A] text-white rounded-lg text-[11px] sm:text-sm font-medium hover:bg-[#2D2D2D] transition-colors"
                        >
                          <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0" /> <span className="truncate">Download CSV</span>
                        </button>
                      </div>
                      <div className="grid grid-cols-2 gap-2 w-full sm:flex sm:w-auto sm:gap-3">
                        <button
