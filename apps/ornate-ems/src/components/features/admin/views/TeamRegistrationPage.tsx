        ...
        teamsList.map((team) =>
          team.id === editingId
            ? {
                ...
                viceCaptain: teamMembers.find((m) => m.role === "Vice Captain")
                  .name,
