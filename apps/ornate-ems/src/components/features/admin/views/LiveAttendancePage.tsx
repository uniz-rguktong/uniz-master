        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Select an event to mark and track attendance in real-time.
            </p>
          </div>
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="bg-white rounded-[14px] p-5 border border-[#E5E7EB] space-y-4"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {filteredEvents.map((event) => (
                <div
                  key={event.id}
                  className={
                    isBranchAdmin ? "bg-[#F4F2F0] rounded-2xl p-2" : ""
                  }
                >
            ...
            <div className="bg-white rounded-[14px] border border-dashed border-[#E5E7EB] p-12 text-center">
              ...
              <p className="text-sm text-[#6B7280] max-w-sm mx-auto">
                There are no events matching your current search or assigned to
                your branch.
              </p>
            </div>
          )}
