...
export function DocumentationPage() {
  ...
  const docs = [
    ...
    // --- Data & Analytics ---
    {
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>Migrate data seamlessly. Use 'Bulk Import' to bring in historical member lists or use 'Export' to generate detailed registration sheets in Excel format for spot analysis.</p>
        </div>
      ),
      questions: [
