...
function Container() {
  return (
    <div
      className="bg-[#eff6ff] content-stretch flex items-center justify-center relative rounded-[10px] shrink-0 size-[48px]"
      data-name="Container"
    >
      <Icon />
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Inter:Medium',sans-serif] font-medium gap-px items-start min-h-px min-w-px not-italic relative">
      <p className="css-4hzbpn leading-[24px] relative shrink-0 text-[#6b7280] text-[16px] w-full">
        Total Registrations
      </p>
      <p className="css-4hzbpn leading-[28px] relative shrink-0 text-[#1a1a1a] text-[20px] w-full">
        466
      </p>
    </div>
  );
  ...
  return (
    ...
    >
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-0 not-italic text-[#22c55e] text-[14px] top-[0.5px] tracking-[-0.1504px]">
          +12%
        </p>
      </div>
    </div>
...
function Container1() {
  return (
    <div
      className="content-stretch flex gap-[4px] h-[20px] items-center relative shrink-0 w-[58.352px]"
      data-name="Container"
    >
      <Icon1 />
      <Text />
