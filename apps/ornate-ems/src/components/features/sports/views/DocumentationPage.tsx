...
export function DocumentationPage() {
  ...
  const docs: DocItem[] = [
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Live Telemetry:</strong> Real-time counts of ongoing
              tournaments, registered teams, and matches.
            </li>
            <li>
              <strong>Quick Actions:</strong> Shortcuts to create fixtures,
              schedule matches, or post updates.
            </li>
            <li>
              <strong>Flash Feed:</strong> A list of the most recent match
              results and team registrations.
            </li>
          </ul>
        </div>
      ),
    ...
    // --- Tournament Engineering ---
    {
      ...
      description:
        "From sport selection to fixture rules—how to launch a new tournament.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-3">
            <li>
              <strong>Phase 1: Metadata:</strong> Define the sport, category
              (Men/Women), and date.
            </li>
            <li>
              <strong>Phase 2: Rules:</strong> Set match duration, team size
              limits, and scoring rules.
            </li>
            <li>
              <strong>Phase 3: Fixtures:</strong> Configure bracket type
              (Knockout/League) and seeding.
            </li>
            <li>
              <strong>Phase 4: Publish:</strong> Open registrations for branch
              teams.
            </li>
          </ul>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Use the <strong>Polls & Fixtures</strong> module to randomize
              matches.
            </li>
            <li>
              Manually drag-and-drop teams to adjust seedings if required.
            </li>
            <li>
              Publish the final schedule to notify all team captains instantly.
            </li>
          </ul>
        </div>
      ),
    ...
    // --- Student Teams ---
    {
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Review:</strong> View all pending team registrations in
              the 'Registrations' tab.
            </li>
            <li>
              <strong>Verify:</strong> Check player eligibility (ID cards,
              medical clearance).
            </li>
            <li>
              <strong>Action:</strong> Approve or reject entries with a single
              click.
            </li>
          </ul>
        </div>
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Navigate to{" "}
              <strong>Tournament Management &gt; Match Results</strong>.
            </li>
            <li>Select the live match from the schedule.</li>
            <li>
              Enter scores and designate the winner to auto-advance them in the
              bracket.
            </li>
          </ul>
        </div>
    ...
    },
    {
      ...
      description:
        "Automated awarding of participation and merit certificates.",
      category: "Scoring & Results",
      readTime: "2 min",
      icon: Award,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              Go to <strong>Results & Awards &gt; Generate Certificates</strong>
              .
            </li>
            <li>
              Select the tournament, position (Gold/Silver), and recipients.
            </li>
            <li>
              Click 'Generate' to create and email secure PDF certificates.
            </li>
          </ul>
        </div>
      ),
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              These assets appear on the main student portal to build
              engagement.
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex-1">
            ...
            <p className="text-sm text-[#6B7280]">
              Comprehensive guides for sports management modules.
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="flex items-center bg-white border border-[#E5E7EB] rounded-[22px] p-1.5 shadow-sm min-w-max">
                {categories.map((cat: Category) => (
                  <button
                    ...
                    className={`px-6 py-2.5 rounded-[18px] text-[12px] font-bold uppercase tracking-wider transition-all duration-500 ${
              ...
              {filteredDocs.map((doc: DocItem, idx: number) => (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mt-auto relative z-10">
                    ...
                    <div
                      className={`w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center group-hover:bg-[#1A1A1A] transition-all duration-500 border border-gray-100 group-hover:border-transparent ${isSportsAdminRoute ? "" : "group-hover:rotate-45"}`}
                    >
