...
const roles = [
  {
    ...
    description:
      "Full administrative access to all sports modules and faculty oversight.",
    users: 2,
    color: "#6366F1",
  ...
  },
  {
    ...
    description:
      "Operational management of tournaments, fixtures, and team approvals.",
    users: 8,
    color: "#10B981",
  ...
  },
  {
    ...
    name: "Team Manager",
    description:
      "Limited access to team roster management and schedule viewing.",
    users: 14,
    color: "#F59E0B",
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-[12px] mt-[10px] mb-[16px]">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() =>
                            showToast(`Modify role: ${role.name}`, "info")
                          }
