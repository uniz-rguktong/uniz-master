    ...
    <div className="p-4 md:p-8 animate-page-entrance">
      <div className="mb-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-[#1A1A1A] tracking-tight mb-2">
              Sports Registration
            </h1>
            ...
            <div className="flex items-center gap-3">
              <Select value={filterCategory} onValueChange={setFilterCategory}>
                ...
                <SelectContent className="rounded-2xl border-[#E5E7EB] shadow-xl p-1">
                  <SelectItem
                    value="all"
                    className="rounded-xl text-xs font-bold uppercase tracking-widest py-3"
                  >
                    All Categories
                  </SelectItem>
                  {categories.map((cat) => (
        ...
        {isLoading ? (
          Array(6)
            ...
            .map((_, i) => (
              <div
                key={i}
                className="bg-white rounded-[24px] border border-[#E5E7EB] p-6 h-[200px] animate-pulse"
              >
              ...
              <div className="p-4 md:p-6 bg-[#F9FAFB]/50 rounded-[26px] group-hover:bg-white transition-colors duration-500">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  ...
                  <div className="p-3 bg-white rounded-2xl border border-gray-100 group-hover:border-orange-100 transition-colors">
                    ...
                    <span className="text-xs font-bold text-[#1A1A1A] truncate block">
                      {sport.venue}
                    </span>
                  </div>
                </div>
                ...
                >
                  <div className="flex flex-col">
                    <span className="text-[9px] font-bold text-white/40 uppercase tracking-[0.2em] mb-0.5">
                      Registration
                    </span>
