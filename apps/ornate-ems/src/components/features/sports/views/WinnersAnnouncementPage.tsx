    ...
    <div className="p-4 md:p-8 animate-page-entrance">
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex flex-wrap items-center gap-1 md:gap-2 text-[10px] md:text-sm text-[#6B7280] mb-3">
          ...
          <span className="text-[#9CA3AF]">›</span>
          <span className="text-[#1A1A1A] font-medium whitespace-nowrap">Winner Announcements</span>
        </div>

        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div>
            <h1 className="text-xl md:text-[28px] font-semibold text-[#1A1A1A] mb-1 md:mb-2">Sports Winners & Awards</h1>
            <p className="text-[10px] md:text-sm text-[#6B7280]">Announce and manage tournament winners and official awards</p>
          </div>
