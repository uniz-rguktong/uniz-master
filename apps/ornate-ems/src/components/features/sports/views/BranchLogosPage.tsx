        ...
        <div className="p-8 animate-page-entrance">
            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
                    <div>
                        <h1 className="text-[28px] font-semibold text-[#1A1A1A] mb-2">{logosLabel} & Assets</h1>
                            ...
                            <div className="flex gap-2 p-1 bg-[#F4F2F0] rounded-lg">
                                {['all', 'promo', 'video'].map((cat) => (
                                    <button
                                        ...
                                        className={`px-4 py-1.5 text-xs font-medium rounded-md transition-all ${categoryFilter === cat
