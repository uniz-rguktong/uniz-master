...
export function AllRegistrationsPage({
  ...
  const offlineRegistrationsCount = totalRegistrations - onlineRegistrationsCount || Math.floor(totalRegistrations * 0.18);
    ...
    <div className="p-4 md:p-8 animate-page-entrance">
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-6">
          <div>
            <h1 className="text-2xl md:text-[28px] font-semibold text-[#1A1A1A] mb-2">Participation Registry</h1>
            <p className="text-sm text-[#6B7280]">Oversee and validate every athlete enrollment for the session.</p>
          </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
              <Select value={filterBranch} onValueChange={handleFilterBranchChange}>
                <SelectTrigger className="w-full sm:w-[160px] h-[42px] bg-[#F7F8FA] border border-[#E5E7EB] rounded-lg text-sm font-medium text-[#1A1A1A]">
                  <SelectValue placeholder={isBranchPortal ? 'All Categories' : 'All Branches'} />
                </SelectTrigger>
                <SelectContent>
                  {isBranchPortal ? (
                    <>
      ...
      <div className="bg-[#F4F2F0] rounded-[18px] px-[10px] py-[24px] pt-[24px] pr-[10px] pb-[10px] pl-[10px] animate-card-entrance mb-8" style={{ animationDelay: '200ms' }}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-[16px] px-[12px]  mt-[-4px]  gap-4">
          <div className="flex items-center gap-2">
            <h2 className="text-xs font-medium text-[#9CA3AF] uppercase tracking-wide text-[14px]">Individual Registrations</h2>
      ...
      <div className="bg-[#F4F2F0] rounded-[18px] px-[10px] py-[24px] pr-[10px] pb-[10px] pl-[10px] animate-card-entrance mb-8" style={{ animationDelay: '300ms' }}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-[16px] px-[12px] mt-[-4px] gap-4">
          <div className="flex items-center gap-2">
            <h2 className="text-xs font-medium text-[#9CA3AF] uppercase tracking-wide text-[14px]">Team Registrations</h2>
