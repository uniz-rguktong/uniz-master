...
const notificationCategories = [
  {
    ...
    description: "Alerts for creation, modification, and fixture generation.",
    accent: "bg-indigo-50 text-indigo-600 border-indigo-100",
    settings: [
      {
        id: "event_created",
        label: "New tournament created",
        email: true,
        push: true,
        sms: false,
      },
