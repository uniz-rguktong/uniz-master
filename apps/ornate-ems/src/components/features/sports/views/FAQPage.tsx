  ...
  const faqs = [
    {
      ...
      answer:
        "To create a new tournament, navigate to the Dashboard and click on 'Add Sport/Tournament'. Defines categories (Men/Women), rules, and fixture settings in a simple guided process.",
      category: "Common Questions",
    },
    {
      question: "Can I manually adjust fixtures?",
      answer:
        "Yes. While the system auto-generates fixtures, you can drag-and-drop teams in the 'Polls & Fixtures' module to adjust seedings or match-ups before publishing.",
      category: "Tournament Rules",
    },
    {
      question: "How are team registrations verified?",
      answer:
        "Go to the 'Registrations' tab. You'll see a list of pending teams. check their player details and eligibility proofs, then click 'Approve' to confirm their entry.",
      category: "Team Management",
    },
    {
      question: "What happens if a match is drawn?",
      answer:
        "For knockout stages, you can input penalty shoot-out scores or extra time results directly in the 'Match Results' section to determine a winner.",
      category: "Tournament Rules",
    },
    {
      question: "How do I update live scores?",
      answer:
        "Select the match from the 'Live Matches' dashboard and use the scoring interface to update points. Changes are reflected instantly on the student portal and leaderboard.",
      category: "Common Questions",
    },
    {
      question: "Can I export match results?",
      answer:
        "Yes, navigate to 'Results & Awards' and use the 'Export Data' feature to download comprehensive match reports and point tables in Excel or PDF format.",
      category: "Technical",
    },
    {
      question: "Is there a limit on team size?",
      answer:
        "You define the team size limits (min/max players) when creating the tournament. The system automatically enforces these rules during team registration.",
      category: "Team Management",
    },
    {
      question: "How do I generate certificates?",
      answer:
        "Go to the 'Results & Awards' section, select the winning teams, and click 'Generate Certificates'. The system creates localized PDFs for all team members.",
      category: "Common Questions",
    },
    {
      question: "Can I disqualify a team?",
      answer:
        "Yes, authorized admins can disqualify a team for rule violations from the 'Team Management' or 'Live Match' control panels. This action is logged for audit purposes.",
      category: "Team Management",
    },
    {
      question: "What if the scoreboard isn't syncing?",
      answer:
        "Check your internet connection first. If the issue persists, try refreshing the page. Persistent sync errors should be reported to technical support immediately.",
      category: "Technical",
    },
  ];
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex-1">
            ...
            <p className="text-sm text-[#6B7280]">
              Find answers to common questions about managing sports events.
            </p>
          </div>
        </div>
      </div>
