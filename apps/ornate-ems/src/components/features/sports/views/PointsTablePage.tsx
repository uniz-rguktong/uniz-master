        ...
        <div className="p-4 md:p-8 animate-page-entrance bg-white min-h-full">
            <div className="mb-6">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-2xl md:text-[28px] font-semibold text-[#1A1A1A] mb-2">Overall Championship</h1>
                        <p className="text-sm text-[#6B7280]">Track departmental leaderboard and standings.</p>
                    </div>
                </div>
