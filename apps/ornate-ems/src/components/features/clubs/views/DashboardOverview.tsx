...
import { Calendar, Users, UserCheck, TrendingUp, ChevronRight } from 'lucide-react';
...
export function DashboardOverview({ user }: DashboardOverviewProps) {
  ...
  const title = displayClubName.toLowerCase().includes('dashboard') ? displayClubName : `${displayClubName} Dashboard`;
  ...
  return (
    <div className="p-4 md:p-8 animate-page-entrance">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <h1 className="text-xl md:text-[28px] font-semibold text-[#1A1A1A] mb-3 md:mb-6">
          {title} Overview
        </h1>
      </div>
          ...
          {isLoading ? (
            ...
            <>
              ...
              <MetricCard
                ...
                iconBgColor="#F5F3FF"
                iconColor="#8B5CF6"
                trend={{ value: `${stats?.activeParticipants || 0}`, isPositive: true, comparisonText: "attendees" }}
              ...
              <MetricCard
                ...
                iconBgColor="#FEF3C7"
                iconColor="#F59E0B"
                trend={{ value: `${stats?.completionRate || 0}%`, isPositive: (stats?.completionRate || 0) > 50, comparisonText: "avg" }}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="lg:col-span-2 animate-card-entrance" style={{ animationDelay: '160ms' }}>
          {isLoading ? <Skeleton height={340} borderRadius={16} /> : <SalesTrendChart />}
        </div>
        <div className="animate-card-entrance" style={{ animationDelay: '200ms' }}>
          {isLoading ? <Skeleton height={340} borderRadius={16} /> : <RevenueBreakdown />}
        </div>
      </div>
