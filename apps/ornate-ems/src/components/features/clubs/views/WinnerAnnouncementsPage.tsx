                ...
                <div className="bg-white rounded-[14px] p-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1 text-sm text-[#6B7280]">
                      Total Events{" "}
                      <InfoTooltip text="Total events with winner announcements" />
                    </div>
              ...
              <div className="bg-[#F4F2F0] rounded-[18px] p-2 pb-6">
                <div className="bg-white rounded-[14px] p-4 flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-1 text-sm text-[#6B7280]">
                      Published{" "}
                      <InfoTooltip text="Announcements currently visible to users" />
                    </div>
          ...
          >
            ...
            <div className="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              {event.positions.map((pos: any) => (
                <div
                  key={pos.rank}
                  className="p-4 border rounded-xl bg-white flex items-start gap-4"
                >
                  ...
                  <div>
                    ...
                    <div className="mt-2 text-sm font-semibold text-[#10B981]">
                      {pos.prize}
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            ...
            {[0, 1, 2].map((idx) => (
              ...
              >
                ...
                <input
                  placeholder="Members (Gmail/Email required for certificate)"
