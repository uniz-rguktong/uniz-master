                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1 text-sm text-[#6B7280]">
                          Total Events{" "}
                          <InfoTooltip text="Total events scheduled on the roadmap" />
                        </div>
                  ...
                  <div className="bg-white rounded-[14px] p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1 text-sm text-[#6B7280]">
                          Upcoming Events{" "}
                          <InfoTooltip text="Events whose date is today or later" />
                        </div>
                  ...
                  <div className="bg-white rounded-[14px] p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1 text-sm text-[#6B7280]">
                          Total Tasks{" "}
                          <InfoTooltip text="All tasks listed in the daily task planner" />
                        </div>
                        <div className="text-2xl font-bold text-[#1A1A1A]">
                          {totalTasks}
                        </div>
                  ...
                  <div className="bg-white rounded-[14px] p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1 text-sm text-[#6B7280]">
                          Completed Tasks{" "}
                          <InfoTooltip text="Tasks currently marked as completed" />
                        </div>
                        <div className="text-2xl font-bold text-[#10B981]">
                          {completedTasks}
                        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTaskFormData({ ...taskFormData, date: e.target.value })
                  }
                  className="w-full px-4 py-3 bg-white border border-[#E5E7EB] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1A1A1A]"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setTaskFormData({ ...taskFormData, time: e.target.value })
                  }
                  className="w-full px-4 py-3 bg-white border border-[#E5E7EB] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1A1A1A]"
                />
              </div>
