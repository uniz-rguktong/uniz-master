...
export function RevenueBreakdown({
  ...
  const totalRegistrations = categoryData.reduce(
    (sum: any, cat: any) => sum + cat.value,
    0,
  );
  const maxValue =
    categoryData.length > 0
      ? Math.max(...categoryData.map((d: any) => d.value))
      : 1;
          ...
          <>
            ...
            <div className="flex flex-wrap items-start justify-between mb-6 md:mb-[32px]">
              <div>
                ...
                <div className="text-[24px] md:text-[32px] font-bold text-[#1F1F1F] tracking-tight">
