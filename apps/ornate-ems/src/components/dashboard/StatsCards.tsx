...
export function StatsCards({ stats, trends }: StatsCardsProps) {
    ...
    const totalEventsTrend: MetricTrendWithComparison | undefined = getTrend(trends?.totalEvents);
    const totalRegistrationsTrend: MetricTrendWithComparison | undefined = getTrend(trends?.totalRegistrations);
    const activeParticipantsTrend: MetricTrendWithComparison | undefined = getTrend(trends?.activeParticipants);
    const completionRateTrend: MetricTrendWithComparison | undefined = getTrend(trends?.completionRate);
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
            ...
            <MetricCard
                ...
                {...(!trends?.totalRegistrations ? { subtitle: 'All registrations' } : {})}
            ...
            <MetricCard
                ...
                {...(!trends?.activeParticipants ? { subtitle: 'Confirmed & attended' } : {})}
