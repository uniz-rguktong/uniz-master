...
export function LogoCard({ logo, isReadOnly = false, onPreview, onDownload, onEdit, onDelete }: LogoCardProps) {
  return (
    <div
      onClick={onPreview}
      ...
      <div className="Card_Container_Inner bg-white rounded-[14px]  flex flex-col gap-4 p-[10px]">
        ...
        <div className="Info_Grid grid grid-cols-1 gap-4">
          <div className="Column_Size">
            ...
            <div className="text-[15px] font-medium text-[#1A1A1A]">{logo.size}</div>
          </div>
        </div>
