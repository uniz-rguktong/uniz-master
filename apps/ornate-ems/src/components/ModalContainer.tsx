...
export function ModalContainer({
  ...
  return createPortal(
    ...
    >
      <div
        className={`bg-[#F4F2F0] rounded-[16px] ${maxWidth} w-full shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)] flex flex-col max-h-[90vh] animate-modal-entrance`}
      >
        {/* Header - #F4F2F0 background */}
        <div
          className="bg-[#F4F2F0] rounded-t-[18px] px-6 py-6"
