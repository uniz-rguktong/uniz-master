...
import { MoreVertical, Edit, Trash2, Copy, Eye, Download, Share2, Archive, Star, CheckCircle, XCircle, Clock, Users, Settings, Send, FileText, Upload, Award } from 'lucide-react';
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          ...
          {actions.map((action: any, index: any) => {
            ...
            if (action.divider) {
              return <DropdownMenu.Separator key={index} className="h-px bg-[#E5E7EB] my-1" />;
            }
