        ...
        <tbody>
          {filteredEvents.map((event: any) =>
            <tr
              ...
              <td className="py-4 px-6 text-sm text-[#6B7280]">{event.dateTime}</td>
              <td className="py-4 px-6 text-sm text-[#6B7280]">{event.venue}</td>
              <td className="py-4 px-6">
              ...
              <td className="py-4 px-6 text-sm text-[#6B7280]">{event.lastModified}</td>
              <td className="py-4 px-6">
