    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <input
          ...
          className={`w-full px-4 py-3 bg-white border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1A1A1A] focus:border-transparent ${data.errors?.eventName ? 'border-red-500' : 'border-[#E5E7EB]'}`} />
        {data.errors?.eventName && <p className="text-xs text-red-500 mt-1">{data.errors.eventName}</p>}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <Select
            ...
            <SelectTrigger className={`w-full h-11.5 bg-white border rounded-lg text-sm focus:ring-2 focus:ring-[#1A1A1A] ${data.errors?.category ? 'border-red-500' : 'border-[#E5E7EB]'}`}>
          ...
          {data.errors?.category && <p className="text-xs text-red-500 mt-1">{data.errors.category}</p>}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            {data.errors?.eventType && <p className="text-xs text-red-500 mt-1">{data.errors.eventType}</p>}
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          maxLength={200}
          rows={3}
          placeholder="Give a brief summary of your event (max 200 chars)"
          className={`w-full px-4 py-3 bg-white border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1A1A1A] resize-none ${data.errors?.shortDescription ? 'border-red-500' : 'border-[#E5E7EB]'}`} />
        {data.errors?.shortDescription && <p className="text-xs text-red-500 mt-1">{data.errors.shortDescription}</p>}
