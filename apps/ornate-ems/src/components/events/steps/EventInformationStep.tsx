...
5. Use of unfair means is strictly prohibited.`}
      ...
      {(data as any).hasPrizes && (
        <div className="animate-in fade-in slide-in-from-top-4 duration-300">
          <h3 className="text-sm font-medium text-[#1A1A1A] mb-4">Prize & Recognition</h3>
          <div className="space-y-4">
            {[
              ...
              map(({ position, color }) =>
                <div key={position} className="p-4 border border-[#E5E7EB] rounded-lg bg-white">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="text-sm font-medium text-[#1A1A1A]">{position} Position</div>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-[#6B7280]">Certificate of Merit</span>
                    </div>
                  </div>
                </div>
              )}
