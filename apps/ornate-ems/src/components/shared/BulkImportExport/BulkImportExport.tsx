  ...
  const handleImport = async () => {
    ...
    try {
      const result = await bulkImportRegistrations(
        parsedData,
        uploadedFile?.name || "unknown_file",
      );
      if (result.success) {
        setImportProgress(100);
        showToast(
          `Successfully imported ${result.successful} registrations`,
          "success",
        );
        fetchImportHistory();
    ...
    <div className="p-8 animate-page-entrance">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Import or export registration data in bulk
            </p>
          </div>
        </div>
        ...
        <div className="inline-flex items-center p-1 bg-[#F4F2F0] rounded-lg border border-[#E5E7EB]/50">
          <button
            ...
            className={`px-6 py-2 text-sm font-medium rounded-[7px] transition-all ${
              activeTab === "import"
      ...
      {activeTab === "import" ? (
        <div className="space-y-6">
          ...
          <div className="bg-[#EFF6FF] border border-[#BFDBFE] rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-sm font-semibold text-[#1E40AF] mb-2">
                  Import Guidelines
                </h3>
                <ul className="text-sm text-[#1E40AF] space-y-1 list-disc list-inside">
                  {config.importGuidelines.map((g: any, i: any) => (
                    <li key={i}>{g}</li>
                  ))}
                </ul>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#F4F2F0] rounded-[16px] p-2.5">
              <h3 className="text-base font-semibold text-[#1A1A1A] mb-4 px-3 mt-2">
              ...
              <div className="bg-white rounded-[16px] p-5">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 flex-1 px-4 py-2.5 bg-[#F9FAFB] border border-[#E5E7EB] rounded-lg text-sm font-medium hover:bg-[#F3F4F6]"
                  >
          ...
          <div className="bg-[#F4F2F0] rounded-[18px] p-2.5">
            <div className="flex items-center justify-between mb-4 px-3 mt-2">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-white border border-[#E5E7EB] rounded-md text-sm font-medium hover:bg-[#F9FAFB]"
              >
                <RefreshCw
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-sm">
                  {importHistory.map((item: any) => (
                    <tr
                      key={item.id}
                      className="border-b last:border-0 hover:bg-[#FAFAFA]"
                    >
                      ...
                      <td className="px-6 py-4 font-semibold text-[#EF4444]">
                        {item.failed}
                      </td>
                      <td className="px-6 py-4">
                        <span className="px-2.5 py-1 bg-[#ECFDF5] text-[#10B981] rounded-full text-xs font-semibold">
                          Completed
                        </span>
                      </td>
                    </tr>
        ...
        <div className="space-y-6">
          {/* Export Settings */}
          <div className="bg-[#F4F2F0] rounded-[18px] p-2.5">
            <h3 className="text-base font-semibold px-3 mt-2 mb-4">
              Export Settings
            </h3>
            <div className="bg-white rounded-[12px] p-6 grid grid-cols-2 gap-6">
              <div>
                ...
                <Select value={dateRange} onValueChange={setDateRange}>
                  <SelectTrigger className="w-full h-[46px] border-[#E5E7EB]">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="">
                    <SelectItem value="All Time" className="">
                      All Time
                    </SelectItem>
                    <SelectItem value="Last 7 Days" className="">
                      Last 7 Days
                    </SelectItem>
                    <SelectItem value="Last 30 Days" className="">
                      Last 30 Days
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div>
                ...
                <Select value={eventFilter} onValueChange={setEventFilter}>
                  ...
                  <SelectContent className="">
                    <SelectItem value="All Events" className="">
                      All Events
                    </SelectItem>
                    {availableEvents.map((e) => (
                      <SelectItem key={e.id} value={e.title} className="">
                        {e.title}
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div>
                ...
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  ...
                  <SelectContent className="">
                    <SelectItem value="All Statuses" className="">
                      All Statuses
                    </SelectItem>
                    <SelectItem value="Confirmed Only" className="">
                      Confirmed Only
                    </SelectItem>
                    <SelectItem value="Pending Only" className="">
                      Pending Only
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div>
                ...
                <Select value={fileFormat} onValueChange={setFileFormat}>
                  ...
                  <SelectContent className="">
                    <SelectItem value="CSV (.csv)" className="">
                      CSV
                    </SelectItem>
                    <SelectItem value="Excel (.xlsx)" className="">
                      Excel
                    </SelectItem>
                  </SelectContent>
                </Select>
          ...
          {/* Export History */}
          <div className="bg-[#F4F2F0] rounded-[18px] p-2.5">
            <h3 className="text-sm font-semibold uppercase tracking-wide px-3 mt-2 mb-4">
              Export History
            </h3>
            <div className="bg-white rounded-[12px] border border-[#E5E7EB] overflow-hidden shadow-sm">
              <table className="w-full text-left">
          ...
          {validationStatus === "error" && (
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full py-2.5 bg-[#F9FAFB] border rounded-lg text-sm font-medium"
              >
                Close
              </button>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-[#ECFDF5] border border-[#A7F3D0] rounded-lg p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#065F46]">
                    Ready to import {parsedData.length} records from{" "}
              ...
              {importing ? (
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => setShowValidationModal(false)}
                    className="flex-1 py-2.5 bg-white border rounded-lg text-sm font-medium hover:bg-[#F9FAFB]"
                  >
                    Cancel
                  </button>
                  <button
                    onClick={handleImport}
                    className="flex-1 py-2.5 bg-[#10B981] text-white rounded-lg text-sm font-semibold hover:bg-[#059669]"
                  >
                    Start Import
                  </button>
                </div>
