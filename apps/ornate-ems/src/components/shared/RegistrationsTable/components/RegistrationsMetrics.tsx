...
interface RegistrationsMetricsProps {
    ...
    trends?: {
        ...
        spotRegistrations?: any;
        revenue?: any;
        attendanceRate?: any;
    };
}

export function RegistrationsMetrics({ isLoading, stats, trends }: RegistrationsMetricsProps) {
    if (isLoading) {
        return (
    ...
    return (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <MetricCard
                ...
                iconBgColor="#EFF6FF"
                iconColor="#3B82F6"
                trend={trends?.onlineRegistrations ? { ...trends.onlineRegistrations, comparisonText: "vs last period" } : undefined}
                tooltip="Registrations completed through the online portal"
            />

            <MetricCard
                title="Total Spot Registrations"
                value={stats.totalSpotRegistrations.toString()}
                icon={Users}
                iconBgColor="#F5F3FF"
                iconColor="#8B5CF6"
                trend={trends?.spotRegistrations ? { ...trends.spotRegistrations, comparisonText: "vs last period" } : undefined}
            ...
            <MetricCard
                ...
                iconBgColor="#F0FDF4"
                iconColor="#10B981"
                trend={trends?.attendanceRate ? { ...trends.attendanceRate, comparisonText: "vs last period" } : undefined}
            ...
            <MetricCard
                ...
                iconBgColor="#FFFBEB"
                iconColor="#F59E0B"
                trend={trends?.revenue ? { ...trends.revenue, comparisonText: "vs last period" } : undefined}
