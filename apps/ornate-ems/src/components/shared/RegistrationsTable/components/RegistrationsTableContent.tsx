                            ...
                            {isLoading ? (
                                [...Array(5)].map((_: any, i: any) => (
                                    <tr key={i} className="border-b border-[#F3F4F6]">
                                        <td className="px-6 py-4">{showSelection ? <Skeleton width={20} height={20} borderRadius={4} /> : null}</td>
                                        {columns.map((col: any) => (
                                            <td key={col.key} className="px-6 py-4"><Skeleton width={100} height={16} /></td>
                                        ))}
                                            ...
                                            <div className="flex items-center justify-end">
                                                <ActionMenu
                                                    actions={[
                                                        ...
                                                        ...(onAnnounceWinners ? [{ label: 'Announce Winners', icon: 'award' as const, onClick: () => onAnnounceWinners(registration) }] : []),
