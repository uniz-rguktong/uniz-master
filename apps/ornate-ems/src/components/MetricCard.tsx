...
export function MetricCard({
  ...
  return (
    <div
      ...
      {/* Trend Indicator */}
      {trend &&
        <div className="hidden md:flex items-center justify-end gap-[4px] px-2 h-[20px]">
          {trend.isPositive ?
          ...
          {trend.comparisonText &&
            <span className="text-[11px] font-medium text-[#9CA3AF] ml-1 hidden md:inline">
              {trend.comparisonText}
            </span>
          }
        </div>
      ...
      {subtitle && !trend &&
        <div className="flex justify-end px-2 h-[20px] hidden md:flex">
