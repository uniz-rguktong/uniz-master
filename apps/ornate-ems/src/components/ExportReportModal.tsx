  ...
  return (
    <ModalContainer
      ...
      <div className="space-y-6">
        {/* Report Settings */}
        <div>
          <h4 className="text-[14px] font-bold text-[#1A1A1A] mb-4">Report Settings</h4>
        ...
        <div className="pt-4 border-t border-[#E5E7EB]">
          <h4 className="text-[14px] font-bold text-[#1A1A1A] mb-4">Event Selection</h4>
          ...
          <div>
            ...
            <p className="text-xs text-[#6B7280] mt-1">Hold Ctrl (Cmd on Mac) to select multiple events</p>
          </div>
        </div>

        {/* Include Options */}
        <div className="pt-4 border-t border-[#E5E7EB]">
          <h4 className="text-[14px] font-bold text-[#1A1A1A] mb-4">Include in Report</h4>
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                <div className="text-[14px] font-normal text-[#1A1A1A]">Include Charts and Graphs</div>
                <div className="text-xs text-[#6B7280]">Visual representations of analytics data</div>
              </div>
            </label>
            ...
            <label className="flex items-center gap-3 cursor-pointer">
              ...
              <div>
                <div className="text-[14px] font-normal text-[#1A1A1A]">Include Detailed Breakdown</div>
                <div className="text-xs text-[#6B7280]">Event-wise registration and revenue details</div>
              </div>
            </label>
          </div>
        </div>
