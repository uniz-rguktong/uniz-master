...
export const metadata: Metadata = {
    title: 'Hall of Fame & Awards — Ornate EMS',
    description: 'Celebrating exceptional graduates and student leaders. Discover the achievements of our Hall of Fame and Best Outgoing Students.',
    openGraph: {
        title: 'Hall of Fame & Awards | Ornate EMS',
        description: 'Meet our most exceptional graduates in academics, leadership, and character.',
        type: 'website',
    }
};
        ...
        <main className="min-h-screen bg-[#FDFCFB]">
            <div className="max-w-[1400px] mx-auto px-6 py-12">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-[#1A1A1A] mb-4">Hall of Fame</h1>
