...
export default function FAQPage() {
    ...
    const categories = ["System Administration", "User Management", "Security & Access", "Troubleshooting"];

    const faqs = [
        // --- System Administration ---
        {
            question: "How do I add a new academic year to the system?",
            answer: "Go to 'Settings' > 'Global Configuration'. Under the 'Academic Years' tab, click 'Add New Period'. This will automatically rollover student year mappings if configured.",
            category: "System Administration"
        },
        {
            question: "Can I put the entire platform into Maintenance Mode?",
            answer: "Yes. In 'Settings' > 'System Health', there is a 'Maintenance Mode' toggle. Enabling this will show a maintenance page to all non-admin users. Use this during major updates.",
            category: "System Administration"
        },
        {
            question: "How do I increase the storage quota for a specific club?",
            answer: "Navigate to 'Club Management', select the entity, and edit their 'Resource Limits'. Increases are applied instantly.",
            category: "System Administration"
        },
        {
            question: "What is the Global Broadcast feature?",
            answer: "It allows Super Admins to send push notifications to EVERY user on the platform. Use sparingly for critical announcements only.",
            category: "System Administration"
        },
        ...
        // --- User Management ---
        {
            ...
            answer: "Find the user in 'User Administration'. In the actions menu, select 'Force Password Reset'. The user will be required to set a new password on next login.",
            category: "User Management"
        },
        {
            question: "Can I bulk import students from an Excel sheet?",
            answer: "Yes. Use the standard CSV template provided in the 'Import' section. Ensure the 'College ID' field is unique to avoid duplication errors.",
            category: "User Management"
        },
        {
            question: "How to merge duplicate student accounts?",
            answer: "Currently, account merging must be done via a database script request. Please raise a ticket with the 'Database Query' category in the Support page.",
            category: "User Management"
        },
        ...
        // --- Security & Access ---
        {
            ...
            answer: "Only users with the 'ROOT_ADMIN' role. This role cannot be assigned casually and requires database-level provisioning.",
            category: "Security & Access"
        },
        {
            question: "Where can I see the audit logs for a specific deletion?",
            answer: "Go to 'Security' > 'Audit Logs'. Filter by 'Action Type: DELETE' and the date range. You will see who performed the action and when.",
            category: "Security & Access"
        },
        {
            question: "Is Two-Factor Authentication (2FA) mandatory?",
            answer: "It is mandatory for Super Admins by default. You can enforce it for Club Admins in the 'Security Policies' settings.",
            category: "Security & Access"
        },
        ...
        // --- Troubleshooting ---
        {
            ...
            answer: "Check the 'System Health' widget. High CPU usage or Database Latency might be the cause. If metrics are normal, check your local network connection.",
            category: "Troubleshooting"
        },
        {
            question: "Emails are not being delivered. Why?",
            answer: "Check the 'SMTP Status' in settings. If the quota is exceeded or credentials have expired, emails will fail. You can view the error log in 'Communication Logs'.",
            category: "Troubleshooting"
        }
    ];
            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                        <h1 className="text-2xl font-bold text-[#1A1A1A] mb-2">System Knowledge Base</h1>
                        <p className="text-sm text-[#6B7280]">Advanced troubleshooting and system administration guides.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="bg-white rounded-[14px] border border-[#E5E7EB] p-4 min-h-[500px]">
                            {isLoading ? (
                                <div className="space-y-4">
                                    {[1, 2, 3, 4, 5].map((i: any) => (
                                        <div key={i} className="rounded-xl border border-transparent p-6 space-y-2 animate-pulse">
