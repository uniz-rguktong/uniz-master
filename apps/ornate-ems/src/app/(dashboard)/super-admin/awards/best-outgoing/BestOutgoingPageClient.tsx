                                    ...
                                    <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 px-3 py-0 mt-1 gap-4">
                                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-3 text-center sm:text-left w-full sm:w-auto">
                                            <div className="relative">
                                                {student.photo ? (
                                                    <Image src={student.photo} alt={student.name} width={80} height={80} className="w-20 h-20 rounded-full object-cover ring-4 ring-[#10B981]/30" />
                                                ) : (
                                                    <div className="w-20 h-20 rounded-full bg-gray-200 ring-4 ring-gray-100 flex items-center justify-center"><Users className="w-8 h-8 text-gray-400" /></div>
                                                )}
                ...
                {branchStudents.length > 0 ? (
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {branchStudents.map((student: any) => {
                            ...
                            return (
                                <div key={student.id} className="bg-white rounded-[18px] p-[10px] py-[16px] border border-[#E5E7EB] shadow-sm">
                                    <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 px-3 py-0 mt-1 gap-4">
                                        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-3 text-center sm:text-left w-full sm:w-auto">
                                            <div className="relative">
                                                {student.photo ? (
                                                    <Image src={student.photo} alt={student.name} width={80} height={80} className="w-20 h-20 rounded-full object-cover ring-2 ring-blue-100" />
                                                ) : (
                                                    <div className="w-20 h-20 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center"><Users className="w-8 h-8 text-gray-400" /></div>
                                                )}
                                    ...
                                    <div className="bg-[#F9FAFB] rounded-[14px] p-5">
                                        ...
                                        <div className="mt-4 pt-4 border-t border-gray-100">
                                            <div className="flex items-center justify-between text-xs text-[#6B7280]">
                                                <span>Status: {student.isPublished ? 'Published' : 'Draft'}</span>
