...
export default function BestOutgoingPageClient({
  initialStudents,
}: BestOutgoingPageClientProps) {
  ...
  const handleSave = async () => {
    if (!formData.name || !formData.rollNumber || !formData.rating) {
      showToast(
        "Please fill in required fields (Name, Roll Number, Rating)",
        "error",
      );
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        showToast(
          editingStudent ? "Updated successfully" : "Added successfully",
          "success",
        );
        if (editingStudent) {
          setStudentsList((prev) =>
            prev.map((s) =>
              s.id === (result as any).data.id ? (result as any).data : s,
            ),
          );
        } else {
    ...
    <div className="p-6 md:p-8 max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <InfoTooltip
              text="Manage and showcase the best outgoing students for each batch"
              size="md"
            />
          </div>
      ...
      <div className="flex flex-col xl:flex-row xl:items-center justify-between mb-6 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          >
            <SelectTrigger className="w-[140px] px-4 py-2 bg-white border border-[#E5E7EB] rounded-lg text-sm font-medium focus:ring-2 focus:ring-[#1A1A1A]">
      ...
      <div className="mb-10">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-bold text-[#1A1A1A]">
                Overall Outgoing Student
              </h2>
              <InfoTooltip
                text="Top student selected across all branches for the academic year"
                size="sm"
              />
            </div>
            <p className="text-sm text-[#6B7280]">
              Top performing students across all branches
            </p>
          </div>
        </div>
        ...
        {overallStudents.length > 0 ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {overallStudents.map((student: any) => {
              ...
              return (
                <div
                  key={student.id}
                  className="bg-[#F4F2F0] rounded-[18px] p-[10px] py-[16px] border border-[#E5E7EB]"
                >
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 px-3 py-0 mt-1 gap-4">
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-3 text-center sm:text-left w-full sm:w-auto">
                      <div className="relative">
                        {student.photo ? (
                          <Image
                            ...
                            width={80}
                            height={80}
                            className="w-20 h-20 rounded-full object-cover ring-4 ring-[#10B981]/30"
                          />
                        ) : (
                          <div className="w-20 h-20 rounded-full bg-gray-200 ring-4 ring-gray-100 flex items-center justify-center">
                            <Users className="w-8 h-8 text-gray-400" />
                          </div>
                        )}
                        <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full flex items-center justify-center border-2 border-white shadow-md bg-gradient-to-br from-[#10B981] to-[#059669]">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="inline-block px-3 py-1 rounded-full text-xs font-semibold text-white bg-gradient-to-r from-[#10B981] to-[#059669]">
                          🏆 Overall Best{" "}
                  ...
                  <div className="bg-white rounded-[14px] p-5">
                    <div className="grid grid-cols-3 gap-4 mb-5 pb-5 border-b border-[#E5E7EB]">
                      <div className="text-center">
                        <div className="text-[24px] font-bold text-[#1A1A1A] mb-1 min-h-[36px] flex items-center justify-center">
                          {ratingValue}
                        </div>
          ...
          <div className="text-center py-8 text-gray-500">
            No overall outgoing students found for the selected filters.
          </div>
        )}
      </div>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-bold text-[#1A1A1A]">
                Branch-wise Best Outgoing Students
              </h2>
              <InfoTooltip
                text="Students selected by their respective branches (Read-only for Super Admin)"
                size="sm"
              />
            </div>
            <p className="text-sm text-[#6B7280]">
              Top students from individual branches
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {branchStudents.map((student: any) => {
              ...
              return (
                <div
                  key={student.id}
                  className="bg-white rounded-[18px] p-[10px] py-[16px] border border-[#E5E7EB] shadow-sm"
                >
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-4 px-3 py-0 mt-1 gap-4">
                    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-3 text-center sm:text-left w-full sm:w-auto">
                      <div className="relative">
                        ...
                        <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full flex items-center justify-center border-2 border-white shadow-md bg-blue-500">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="inline-block px-3 py-1 rounded-full text-xs font-semibold text-gray-600 bg-gray-100">
                  ...
                  <div className="bg-[#F9FAFB] rounded-[14px] p-5">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <div className="flex items-center justify-between text-xs text-[#6B7280]">
                        <span>
                          Status: {student.isPublished ? "Published" : "Draft"}
                        </span>
                        <span className="italic">Added by Branch Admin</span>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {editingStudent
                    ...
                    : "Add a new best outgoing student"}
                </p>
              </div>
              <button
                onClick={() => {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2.5 bg-white border border-[#E5E7EB] rounded-lg text-sm flex items-center justify-center gap-2 hover:bg-[#F7F8FA] transition-colors disabled:opacity-60"
            ...
            <div className="p-5 border-t border-gray-100 flex justify-end gap-3 sticky bottom-0 bg-white z-10">
              ...
              <button
                onClick={handleSave}
                className="px-5 py-2.5 bg-[#10B981] text-white rounded-xl text-sm font-medium shadow-lg shadow-green-100 flex items-center gap-2"
              >
