...
const SCHEDULED_ANNOUNCEMENTS = [
  {
    ...
    description:
      "Reminder for all students and faculty to attend the Grand Inauguration Ceremony at Main Auditorium. Gates open at 7:30 AM.",
    audience: "Everyone",
  ...
  },
  {
    ...
    description:
      "The detailed performance schedule for Cultural Night is ready. All participants must report to green room 30 minutes before their slot.",
  ...
  },
  {
    ...
    description:
      "Last call for Sports Day registrations! Register now to participate in the inter-branch sports championship.",
  ...
  },
  {
    ...
    description:
      "Workshop materials and pre-requisites for the AI/ML Workshop are now available for download. Please review before the session.",
  ...
  },
  {
    ...
    description:
      "The mid-semester examination schedule has been finalized. Students can view their individual timetables in the portal.",
    audience: "All Students",
    channels: ["Push", "Banner", "Email"],
    status: "Queued",
  },
...
export default function ScheduledAnnouncementsPage() {
  ...
  const handleSaveEdit = () => {
    setScheduledList((prev: any) =>
      prev.map((item: any) =>
        item.id === editingId
          ? {
              ...item,
              ...editForm,
              scheduledFor: toScheduledForDisplay(editForm.scheduledFor),
            }
          : item,
      ),
    );
  ...
  const confirmSend = () => {
    ...
    setScheduledList((prev: any) =>
      prev.filter((item: any) => item.id !== sendId),
    );
    setSendId(null);
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Manage upcoming automated broadcasts and messages.
            </p>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-semibold ${getTypeColor(announcement.type)}`}
                        >
                          {announcement.type}
                        </span>
                        <span
                          className={`px-2.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider border ${getStatusColor(announcement.status)}`}
                        >
                          {announcement.status}
                        </span>
                      </div>
