...
const CLUBS = [
    { id: 'techexcel', name: 'TechXcel Club' },
        ...
        <div className="p-6 md:p-8 max-w-[1200px] mx-auto">
            <div className="flex items-start justify-between mb-8 gap-4">
                <div className="flex-1 min-w-0">
                    <h1 className="text-2xl font-bold text-[#1A1A1A] leading-tight flex items-center flex-wrap gap-x-2">
                        Broadcast Announcement
                        <InfoTooltip text="Create and send important updates to students and staff" size="md" />
                    </h1>
                    <p className="text-sm text-[#6B7280] mt-1">Directly reach all target users instantly.</p>
                </div>
                <button
                    onClick={handleSendNow}
                    disabled={isSubmitting}
                    className="flex items-center gap-1.5 px-3 sm:px-6 py-2 sm:py-2.5 bg-[#1A1A1A] text-white rounded-xl text-xs sm:text-sm font-medium hover:bg-[#2D2D2D] transition-colors shadow-lg shadow-gray-200 flex-shrink-0 mt-0.5">
            ...
            <div className="mt-10">
                <div className="flex items-center justify-between mb-6">
                    <div>
                        <h2 className="text-2xl font-bold text-[#1A1A1A] leading-tight flex items-center flex-wrap gap-x-2">
                            ...
                            <div className="bg-white rounded-[14px] p-6">
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-start gap-3 sm:gap-4">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-amber-400 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-100 shrink-0">
                                ...
                                <div className="flex flex-col gap-4 pt-4 border-t border-[#E5E7EB] sm:flex-row sm:items-center sm:justify-between">
                                    <div className="flex items-center gap-4 flex-wrap">
                                        <div className="flex items-center gap-2 text-[#6B7280]">
                                            <Layout className="w-4 h-4" />
                                            <span className="text-xs sm:text-sm">{announcement.targetAudience}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-[#6B7280]">
                                            <Clock className="w-4 h-4" />
                                            <span className="text-xs sm:text-sm">Expires: {new Date(announcement.expiryDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</span>
                                        </div>
                                    </div>
            ...
            <div className="mt-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <MetricCard
                        ...
                        iconBgColor="#EEF2FF"
                        iconColor="#4F46E5"
                        tooltip="Total number of announcements sent across all categories"
                        delay={0}
                    />
                    <MetricCard
                        title="Important"
                        value={history.filter(a => a.category === 'Important').length}
                        icon={Megaphone}
                        iconBgColor="#FEF2F2"
                        iconColor="#EF4444"
                        tooltip="Critical updates marked as high-priority"
                        delay={100}
                    />
                    <MetricCard
                        title="Events"
                        value={history.filter(a => a.category === 'Events').length}
                        icon={Clock}
                        iconBgColor="#ECFDF5"
                        iconColor="#10B981"
                        tooltip="Scheduled or ongoing event notifications"
                        delay={200}
                    />
                    <MetricCard
                        title="Total Views"
                        value={history.reduce((sum: any, a: any) => sum + (a.viewCount || 0), 0).toLocaleString()}
                        icon={Eye}
                        iconBgColor="#FFF7ED"
                        iconColor="#F97316"
                        tooltip="Cumulative engagement across all sent broadcasts"
                        delay={300}
                    />
                </div>
                    ...
                    {isHistoryLoading ? (
                        ...
                        >
                            <div className="bg-white rounded-[14px] p-6">
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-start gap-3 sm:gap-4">
                                        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center shadow-lg shadow-red-100 shrink-0">
                                ...
                                <div className="flex flex-col gap-4 pt-4 border-t border-[#E5E7EB] sm:flex-row sm:items-center sm:justify-between">
                                    <div className="flex items-center gap-4 flex-wrap">
                                        <div className="flex items-center gap-2 text-[#6B7280]">
                                            ...
                                            <span className="text-xs sm:text-sm">{(announcement.viewCount || 0).toLocaleString()}</span>
                                        </div>
                                        <div className="flex items-center gap-2 text-[#6B7280]">
                                            <Layout className="w-4 h-4" />
                                            <span className="text-xs sm:text-sm">{announcement.targetAudience}</span>
                                        ...
                                        <div className="flex items-center gap-2 text-[#6B7280]">
                                            <Clock className="w-4 h-4" />
                                            <span className="text-xs sm:text-sm">Exp: {new Date(announcement.expiryDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2 self-end sm:self-auto">
                                        <button
