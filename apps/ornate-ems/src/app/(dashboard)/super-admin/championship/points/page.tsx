        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Configure scoring rules for various event categories.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-[#F4F2F0] rounded-[18px] p-[10px]">
          <div className="bg-white rounded-[14px] p-6 space-y-4">
            <h3 className="font-bold text-[#1A1A1A] border-b border-gray-100 pb-2">
              Technical & Cultural (Standard)
            </h3>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="number"
                  defaultValue={10}
                  className="w-full mt-1 px-3 py-2 border border-gray-200 rounded-lg text-sm bg-gray-50 focus:bg-white transition-colors"
                />
              </div>
              <div>
                <label className="text-xs font-bold text-gray-500 uppercase">
        ...
        <div className="flex items-start gap-3 p-4 bg-yellow-50 text-yellow-800 rounded-xl md:col-span-2">
          ...
          <p className="text-sm">
            Modification of point values mid-event will trigger a full
            recalculation of the leaderboard. This action is logged and
            irreversible.
          </p>
        </div>
      </div>
