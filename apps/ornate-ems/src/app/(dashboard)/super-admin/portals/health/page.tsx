    ...
    <div className="p-6 md:p-8 max-w-[1600px] mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Real-time performance metrics across all portal instances.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {METRICS.map((metric: any, i: any) => (
          <div
            key={i}
            className="bg-white p-6 rounded-[18px] border border-[#E5E7EB] shadow-sm flex items-start justify-between"
          >
            <div>
              ...
              <span
                className={`inline-flex items-center gap-1 mt-2 px-2 py-0.5 rounded text-xs font-semibold ${metric.bg} ${metric.color}`}
              >
          ...
          <div className="bg-white rounded-[14px] p-6 h-full">
            ...
            <div className="space-y-4">
              {INCIDENTS.map((inc: any) => (
                ...
                >
                  <div
                    className={`w-2 h-full rounded-full shrink-0 self-stretch my-1 
                                        ${
