...
export default async function EventSchedulePage() {
  ...
  // Group items by date
  const groupedSchedule = (scheduleItems as any[]).reduce(
    (acc: any, item: any) => {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-[#6B7280] mt-1">
              Real-time schedule of all events across the fest across all
              categories.
            </p>
          </div>
        </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <span
                            className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold border ${getTypeColor(item.type)} uppercase tracking-wider`}
                          >
