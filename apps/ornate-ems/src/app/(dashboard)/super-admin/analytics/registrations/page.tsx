...
const CLUB_REG_DATA = [
    { branch: 'TechXcel', male: 0, female: 0, total: 0 },
    ...
    return (
        <Suspense fallback={<LoadingSkeleton />}>
            <div className="p-6 md:p-8 max-w-[1600px] mx-auto">
                <div className="flex flex-col gap-4 mb-8">
                    <div>
                        <h1 className="text-2xl md:text-[28px] font-semibold text-[#1A1A1A]">Registration Insights</h1>
                ...
                <div className="bg-[#F4F2F0] rounded-[18px] p-2.5 mb-8 animate-card-entrance">
                    ...
                    <div className="overflow-x-auto pb-4 custom-scrollbar">
                        <div className="bg-white rounded-[14px] border border-[#E5E7EB] p-5 shadow-sm min-w-[750px] md:min-w-full">
