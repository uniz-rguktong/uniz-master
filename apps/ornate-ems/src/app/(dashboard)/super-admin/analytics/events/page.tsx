...
export default async function EventsAnalyticsPage() {
    ...
    if (res.success && res.data && res.data.events) {
        ...
        res.data.events.forEach(event => {
            ...
            bucket['Total Registrations'] += (event.onlineRegistrations || 0) + (event.spotRegistrations || 0);
        });
    ...
    return (
        <div className="p-6 md:p-8 max-w-[1200px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
                <div>
                    <h1 className="text-2xl md:text-[28px] font-semibold text-[#1A1A1A]">Event Performance</h1>
            ...
            <div className="bg-[#F4F2F0] rounded-[18px] p-2.5 mb-8 animate-card-entrance">
                ...
                <div className="overflow-x-auto pb-4 custom-scrollbar">
                    <div className="bg-white rounded-[14px] border border-[#E5E7EB] p-5 shadow-sm min-w-[800px] md:min-w-full">
