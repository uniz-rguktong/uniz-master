...
const LIVE_ACTIONS = [
  {
    ...
    detail: "John Doe (CSE) joined",
    time: "Just now",
  },
  {
    id: 2,
    action: "Page View",
    detail: "/schedule visited from India",
    time: "2s ago",
  },
  {
    id: 3,
    action: "Vote Cast",
    detail: "Dance Competition - Team Alpha",
    time: "5s ago",
  },
      ...
      <div className="bg-white rounded-[18px] border border-[#E5E7EB] shadow-sm p-6">
        ...
        <div className="space-y-4">
          {LIVE_ACTIONS.map((item: any) => (
            <div
              key={item.id}
              className="flex items-center justify-between p-3 bg-gray-50 rounded-lg animate-in fade-in slide-in-from-left-4 duration-500"
            >
              <div>
