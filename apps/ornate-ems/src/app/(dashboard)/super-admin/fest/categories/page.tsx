...
const INITIAL_CATEGORIES = [
  {
    ...
    color: "#4F46E5",
    count: 45,
    tags: ["Coding", "Robotics", "Paper Presentation"],
  },
  {
    id: 2,
    name: "Cultural",
    ...
    <div className="p-6 md:p-8 max-w-[1200px] mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <InfoTooltip
                text="Classify events for better organization and filtering"
                size="md"
              />
            </div>
            <p className="text-sm text-[#6B7280]">
              Manage event classifications and search tags.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {INITIAL_CATEGORIES.map((cat: any) => (
          <div
            key={cat.id}
            className="bg-[#F4F2F0] rounded-[18px] p-[10px] group hover:-translate-y-1 transition-transform duration-300"
          >
