...
async function StatsSection() {
  ...
  const metrics: MetricItem[] = [
    ...
    },
    {
      ...
      iconBgColor: "#F5F3FF",
      iconColor: "#7C3AED",
      trend: stats.activeAnnouncements.trend,
    },
  ];
      ...
      <div className="space-y-4">
        {portals.length === 0 ? (
          ...
          portals.map((portal: any, index: any) => (
            <div
              key={portal.name}
              className="flex items-center gap-4 p-2 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer group"
            >
              <div
                className={`
      ...
      <div className="space-y-3">
        {events.length === 0 ? (
          ...
          events.map((event: any) => (
            <div
              key={event.id}
              className="flex items-center gap-4 p-3 border border-gray-100 rounded-xl hover:bg-gray-50 hover:border-gray-200 transition-all"
            >
      ...
      <div className="space-y-4">
        {approvals.length === 0 ? (
          ...
          approvals.slice(0, 5).map((item: any) => (
            <div
              key={item.id}
              className="flex items-start gap-4 p-3 border border-gray-100 rounded-xl hover:bg-gray-50 transition-all"
            >
      ...
      <div className="space-y-4">
        {announcements.length === 0 ? (
          ...
          announcements.map((item: any) => (
            <div
              key={item.id}
              className="flex items-start gap-4 p-3 hover:bg-gray-50 rounded-xl transition-all"
            >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Real-time system health and participation analytics across all
              portals.
            </p>
          </div>
