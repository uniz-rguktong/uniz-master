...
const ROLES = [
    {
        ...
        description: 'Full system access with ability to manage all aspects of the fest.',
    ...
    }, // Orange for activity/sports
    {
        ...
        description: 'Branch-level sports administrator with scoped access to registrations and results.',
        ...
        <div className="p-6 md:p-8 max-w-[1600px] mx-auto">
             <div className="flex flex-col gap-4 mb-8">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-[#1A1A1A]">Role Management</h1>
                        <p className="text-sm text-[#6B7280]">Define and audit access levels across the platform.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {ROLES.map((role: any) => (
                    <div key={role.id} className="bg-[#F4F2F0] rounded-[18px] p-2 hover:translate-y-[-2px] transition-transform duration-300">
                        <div className="bg-white rounded-[14px] p-6 h-full flex flex-col">
                            ...
                            <h3 className="text-lg font-bold text-[#1A1A1A] mb-2">{role.name}</h3>
                            ...
                            <div className="mt-6 pt-4 border-t border-gray-100 flex items-center justify-between">
                                ...
                                <span className="text-xs font-medium text-[#1A1A1A] cursor-pointer hover:underline">View Policy Details</span>
                            </div>
                        </div>
                    </div>
                ))}
