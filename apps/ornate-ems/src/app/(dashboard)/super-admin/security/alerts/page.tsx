...
const ALERTS = [
  {
    ...
    severity: "High",
    description: "Multiple failed login attempts detected from IP 45.12.XX.XX",
    time: "10m ago",
    status: "Open",
  },
  {
    ...
    severity: "Medium",
    description: 'User "BranchAdmin" exported 5,000 records.',
    time: "1h ago",
  ...
  },
  {
    ...
    severity: "Low",
    description: 'New role "Club Coordinator" assigned to staff@ornate.edu',
    time: "Yesterday",
    status: "Resolved",
  },
];
    ...
    <div className="p-6 md:p-8 max-w-[1200px] mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Real-time security incidents and anomalies.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {ALERTS.map((alert: any) => (
          <div
            key={alert.id}
            className="bg-white p-6 rounded-[18px] border border-[#E5E7EB] shadow-sm flex items-start gap-4 hover:shadow-md transition-shadow"
          >
            <div
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="text-xs font-semibold text-gray-500 hover:text-[#1A1A1A]"
                >
                  Dismiss
                </button>
              </div>
