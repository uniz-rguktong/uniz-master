...
// This pattern allows granular streaming
        ...
        <div className="p-4 md:p-8 animate-page-entrance">
            ...
            <div className="mb-0">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-[28px] font-semibold text-[#1A1A1A] mb-2">{title}</h1>
                        <p className="text-sm text-[#6B7280]">Comprehensive analytics and event tracking for your department.</p>
                    </div>
                </div>

                {/* Metric Cards - Streams in first */}
                <Suspense fallback={<MetricsSectionSkeleton />}>
                    <StatsCardsLoader />
                </Suspense>
            </div>

            {/* Charts Section - Streams in second (slower) */}
            <Suspense fallback={<ChartsSectionSkeleton />}>
                <ChartsLoader />
            </Suspense>

            {/* Transactions Table - Streams in last */}
