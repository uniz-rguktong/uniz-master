...
export default function ClubsPortalError({
    error,
    reset,
}: {
        ...
        <div className="flex h-screen w-full flex-col items-center justify-center bg-black text-white p-4">
            <div className="flex max-w-md flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-2">
                    <h1 className="text-3xl font-bold tracking-tight text-white">Clubs Portal Error</h1>
                ...
                <div className="flex gap-4 pt-4">
                    ...
                    <Button asChild variant="outline" size="default" className="flex items-center gap-2 border-gray-800 bg-transparent text-white hover:bg-[#1A1A1A] hover:text-white transition-colors">
                        <Link href="/clubs-portal">
                ...
                {error.digest && (
                    <p className="text-xs text-gray-600 mt-8 font-mono bg-gray-900/50 px-2 py-1 rounded">Error ID: {error.digest}</p>
                )}
            </div>
        </div>
    );
