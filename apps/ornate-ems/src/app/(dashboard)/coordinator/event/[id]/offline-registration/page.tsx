...
export default function OfflineRegistrationPage({ params }: OfflineRegistrationPageProps) {
    ...
    const handleSaveEditedRegistration = async () => {
        ...
        if (editRegistration.team) {
            ...
            const paymentRes = await updateCoordinatorOfflineRegistration(paymentPayload);
                ...
                <div className="lg:col-span-8 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="bg-white border border-[#E5E7EB] rounded-2xl p-5 shadow-sm">
                            <div className="text-[#6B7280] text-xs font-bold uppercase tracking-widest mb-1">Total Offline</div>
                            ...
                            <form onSubmit={teamForm.handleSubmit(onTeamSubmit)} className="space-y-6">
                                <div className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-2">
                                        ...
                                        <div className="space-y-1.5">
                                            <label className="text-[10px] font-bold text-[#6B7280] uppercase tracking-widest ml-1">Leader Email</label>
                                            <input
                            ...
                            <form onSubmit={individualForm.handleSubmit(onIndividualSubmit)} className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            {...individualForm.register('studentName', { required: true })}
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <input
                                            {...individualForm.register('studentId', { required: true })}
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-bold text-[#6B7280] uppercase tracking-widest ml-1">Email</label>
                                        <input
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-bold text-[#6B7280] uppercase tracking-widest ml-1">Phone <span className="text-[#EF4444]">*</span></label>
                                        <input
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-4 border-t border-[#F3F4F6]">
                                <p className="text-[10px] text-[#9CA3AF] italic leading-relaxed">
                                    Offline entries are marked &quot;Offline Entry&quot; in the system for verification.
                                </p>
                            </div>
                        </div>
                    </div>
