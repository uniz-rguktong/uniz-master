...
export const PROMO_PATHS = ["/clubs-portal/content/promo-video"] as const;
...
export const STALL_PATHS = ["/super-admin/stalls"] as const;

export const FEST_PATHS = ["/super-admin/fest/setup", "/"] as const;
