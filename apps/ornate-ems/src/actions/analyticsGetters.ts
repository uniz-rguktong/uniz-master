...
const CLUB_DISPLAY_ORDER = ['TechExcel', 'Sarvasrijana', 'Artix', 'Kaladharini', 'KhelSaathi', 'ICRO', 'Pixelro'];
        ...
        const data = await unstable_cache(
            async () => {
                ...
                const trends: AnalyticsTrends = {
                    ...
                    offlineRegistrations: yesterdaySnapshot ? calculateTrend(totalOfflineRegistrations, yesterdaySnapshot.totalOfflineRegistrations) : null,
