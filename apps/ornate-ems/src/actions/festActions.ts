...
export async function updateFestSettings(data: FestSettingsInput) {
  ...
  return executeAction(async () => {
    ...
    if (data.startDate !== undefined)
      payload.startDate = data.startDate ? new Date(data.startDate) : null;
    ...
    if (data.registrationOpen !== undefined)
      payload.registrationOpen = data.registrationOpen;
    if (data.maintenanceMode !== undefined)
      payload.maintenanceMode = data.maintenanceMode;
    if (data.guestRegistration !== undefined)
      payload.guestRegistration = data.guestRegistration;
    if (data.emailNotifications !== undefined)
      payload.emailNotifications = data.emailNotifications;
    if (data.instagramUrl !== undefined)
      payload.instagramUrl = data.instagramUrl;
