  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <p style="color: #888; font-size: 12px; margin-top: 30px; text-align: center;">
            This is an automated message from Ornate Core. Please do not reply directly to this email.
        </p>
    </div>
    `;
};
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <p style="color: #9ca3af; font-size: 11px; margin-top: 30px; text-align: center;">
            This is an official notification from Ornate Core.
        </p>
    </div>
    `;
};
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 8px;">
        ...
        <div style="background-color: #f3f4f6; padding: 15px; border-radius: 0 0 6px 6px; text-align: center;">
            <p style="color: #888; font-size: 11px; margin: 0;">
                This is an automated receipt from Ornate Core. If you have any questions, please contact your Branch Sports Coordinator.
            </p>
        </div>
    </div>
    `;
...
export const sendEmail = async ({
  ...
  try {
    const command = new SendEmailCommand({
      Source: `"Ornate Core Updates" <${FROM_EMAIL()}>`,
      Destination: { ToAddresses: [to] },
      Message: {
        Subject: { Data: subject, Charset: "UTF-8" },
        Body: { Html: { Data: html, Charset: "UTF-8" } },
