...
export const metadata = {
  title: "Certificate Verification | Ornate Core",
  description: "Verify the authenticity of a certificate issued by Ornate Core.",
};
...
export default async function VerificationPage({
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="max-w-md w-full bg-white shadow-lg rounded-xl p-8 text-center border border-red-100">
          ...
          <p className="text-gray-600">
            The certificate ID you scanned does not exist or has not been issued
            yet.
          </p>
        </div>
      </div>
  ...
  const { studentName, event, rank, certificateType, certificateIssuedAt } =
    registration;
  const isWinner = rank && rank <= 3;

  // Format date
  const issuedDate = new Date(
    certificateIssuedAt || registration.createdAt,
      ...
      <div className="max-w-lg w-full bg-white shadow-2xl rounded-2xl overflow-hidden border border-gray-100 relative">
        ...
        <div className="pt-12 pb-8 px-8 text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">
            This certificate is valid and issued by Ornate Core
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
              ...
              <div className="flex items-center justify-center gap-2 mt-2 text-sm text-gray-600">
                ...
                <span className="font-medium">
                  {isWinner
                    ? `${rank === 1 ? "1st" : rank === 2 ? "2nd" : "3rd"} Prize Winner`
                    : "Participation"}
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 text-left text-xs bg-gray-50 p-4 rounded-xl border border-gray-100">
              <div>
                <span className="block text-gray-400 uppercase tracking-wider font-semibold">
                  Issue Date
                </span>
            ...
            <div className="flex flex-col gap-3 pt-4">
              <a
                href={`/api/certificates/download/${id}`}
              ...
              <Link
                href="/"
                className="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-white text-gray-600 font-semibold rounded-xl border border-gray-200 hover:bg-gray-50 transition"
              >
