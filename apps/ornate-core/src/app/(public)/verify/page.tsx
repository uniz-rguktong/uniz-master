...
export const metadata = {
  title: "Verify Certificate | Ornate Core",
  description: "Verify certificates issued by Ornate Core.",
};
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4 py-12">
      ...
      <div className="max-w-xl w-full text-center mt-8 text-sm text-gray-400">
        <p>Having trouble? Contact support at support@ornate-core.com</p>
      </div>
    </div>
  );
}
