    ...
    <div className="p-6 md:p-8 max-w-[1200px] mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Traffic analysis across different sub-domains.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {PORTALS.map((portal: any) => (
          <div
            key={portal.name}
            className="bg-white rounded-[18px] border border-[#E5E7EB] p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden"
          >
            <div className="flex justify-between items-start mb-6">
              ...
              <span
                className={`px-2 py-1 rounded text-xs font-bold uppercase ${portal.active ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
              >
