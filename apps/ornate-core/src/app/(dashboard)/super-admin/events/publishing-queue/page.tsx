...
const QUEUE = [
  {
    id: 1,
    name: "Hackathon Rulebook",
    type: "Update",
    target: "Technical Portal",
  ...
  {
    id: 3,
    name: "Sports Fixtures (Round 1)",
    type: "Data Sync",
    target: "Sports Portal",
    scheduledFor: "Feb 13, 08:00",
    status: "Queued",
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Manage scheduled updates and content releases.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {QUEUE.map((item: any) => (
            <div
              key={item.id}
              className="bg-white border border-[#E5E7EB] rounded-[18px] p-6 flex items-start justify-between group hover:shadow-md transition-shadow"
            >
