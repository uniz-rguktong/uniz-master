        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Configure features and restrictions for all branch portals.
            </p>
          </div>
          <button
            onClick={() =>
              showToast(
                "Global portal settings updated successfully",
                "success",
              )
            }
        ...
        <div className="bg-[#F4F2F0] rounded-[18px] p-[10px]">
          <div className="bg-white rounded-[14px] p-6">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Enable or disable modules visible to students.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Allow students to register for events",
                  active: true,
                },
                {
                  label: "Gallery Uploads",
                  desc: "Allow users to submit photos for approval",
                  active: true,
                },
                {
                  label: "Live Results",
                  desc: "Show sports and competition results publicly",
                  active: false,
                },
                {
                  label: "Comment System",
                  desc: "Enable comments on event pages",
                  active: false,
                },
        ...
        <div className="bg-[#F4F2F0] rounded-[18px] p-[10px]">
          <div className="bg-white rounded-[14px] p-6">
            ...
            <div className="mt-6 p-4 bg-yellow-50 rounded-xl flex gap-3 text-yellow-800 text-sm">
              ...
              <p>
                Warning: Changing quotas will apply immediately. Students
                exceeding new limits won&apos;t be blocked until their next
                action.
              </p>
            </div>
          </div>
