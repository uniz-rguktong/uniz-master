...
export default function DocumentationPage() {
  ...
  const docs = [
    // --- System Management ---
    {
      ...
      description:
        "Understanding system-wide telemetry, health metrics, and global alerts.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            ...
            platform. Key metrics include:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>System Health:</strong> CPU, Memory, and Storage usage
              stats of the hosting server.
            </li>
            <li>
              <strong>Active Users:</strong> Real-time count of currently
              logged-in users across all portals.
            </li>
            <li>
              <strong>Global Alerts:</strong> Critical notifications regarding
    ...
    },
    {
      ...
      description:
        "Provisioning new clubs, managing existing entities, and archiving inactive ones.",
      category: "System Management",
      readTime: "4 min",
      icon: Zap,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Super Admins have full control over the organizational structure:
          </p>
          <ul className="list-disc pl-5 space-y-3">
            <li>
              <strong>Onboarding:</strong> Create new club entities with default
              admins and resources.
            </li>
            <li>
              <strong>Configuration:</strong> Set storage quotas and feature
              flags for specific clubs.
            </li>
            <li>
              <strong>Lifecycle:</strong> Suspend or archive clubs that are no
              longer active.
            </li>
          </ul>
        </div>
    ...
    // --- User & Roles ---
    {
      ...
      description:
        "Managing student accounts, faculty staff, and external vendors.",
      category: "User & Roles",
      readTime: "5 min",
      icon: Users,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Bulk Import:</strong> Onboard batch of students via CSV
              upload.
            </li>
            <li>
              <strong>Profile Editing:</strong> Update critical user information
              and reset credentials.
            </li>
            <li>
              <strong>Access Control:</strong> Lock accounts or force password
              resets for security.
            </li>
          </ul>
        </div>
    ...
    },
    {
      ...
      description:
        "Configuring Role-Based Access Control policies and custom roles.",
      category: "User & Roles",
      readTime: "6 min",
      icon: ShieldCheck,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Role Definitions:</strong> Create granular roles with
              specific capabilities (e.g., 'Finance Viewer').
            </li>
            <li>
              <strong>Permission Matrix:</strong> visual editor for assigning
              API endpoints to roles.
            </li>
            <li>
              <strong>Inheritance:</strong> Understanding how permissions
              cascade from global to local scope.
            </li>
          </ul>
        </div>
      ),
    ...
    // --- Data & Reports ---
    {
      ...
      description:
        "Generating comprehensive reports across all clubs and events.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Financial Reports:</strong> Aggregate revenue and
              transaction summaries.
            </li>
            <li>
              <strong>Participation Stats:</strong> Analyze engagement trends
              across different departments.
            </li>
            <li>
              <strong>Custom Query Builder:</strong> Create specific datasets
              for ad-hoc analysis.
            </li>
          </ul>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Snapshot Schedule:</strong> Configure frequency of
              automated backups.
            </li>
            <li>
              <strong>Point-in-Time Recovery:</strong> Restore the database to a
              specific second.
            </li>
            <li>
              <strong>Disaster Recovery Drills:</strong> Simulating data loss
              scenarios.
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-[#6B7280]">
              Technical guides and references for Super Administrators.
            </p>
          </div>
        </div>
      </div>
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i: any) => (
                <div
                  key={i}
                  className="border border-[#F3F4F6] rounded-[16px] p-6 bg-[#FAFAFA]/50 animate-pulse"
                >
