        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Generate specific datasets by querying the database.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-[18px] p-6 border border-[#E5E7EB] shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <label
                  key={source}
                  className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50 has-checked:border-indigo-500 has-checked:bg-indigo-50"
                >
                  <input
                    type="radio"
                    name="source"
