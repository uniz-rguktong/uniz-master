...
const PRESET_ALERTS = [
  {
    ...
    msg: "Adverse weather conditions detected. Move to designated indoor areas immediately.",
    color: "bg-yellow-500",
  },
  {
    title: "Schedule Disruption",
    msg: "Multiple events are delayed by >1 hour. Update schedules in progress.",
    color: "bg-orange-500",
  },
  {
    title: "Evacuation",
    msg: "EMERGENCY EVACUATION. Proceed to nearest exit calmly. Follow volunteer instructions.",
    color: "bg-red-500",
  },
];
    ...
    <div className="p-6 md:p-8 max-w-[1000px] mx-auto">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Urgent broadcast system for critical incidents.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-red-50 border border-red-100 rounded-[18px] p-8 mb-8 text-center animate-in zoom-in-95 duration-300">
        ...
        <p className="text-red-700 max-w-lg mx-auto mb-6">
          Sending an alert from this console will{" "}
          <strong>override all active screens</strong> on student and admin
          portals. Push notifications will be sent with &quot;Critical&quot;
          priority sound.
        </p>
      </div>
