    ...
    <div className="p-6">
          ...
          className="p-2 hover:bg-gray-100 rounded-full transition-colors">
            ...
            <div className="space-y-6">
                <div>
                    <h3 className="text-sm font-medium text-[#374151] mb-3">Event Status</h3>
                    <div className="space-y-2">
                        {['Upcoming', 'Ongoing', 'Completed', 'Draft'].map((status: any) =>
            <label key={status} className="flex items-center gap-2 cursor-pointer">
                ...
                <div>
                    <h3 className="text-sm font-medium text-[#374151] mb-3">Event Type</h3>
                    <div className="space-y-2">
                        {['Technical', 'Workshops', 'Hackathons', 'Cultural'].map((type: any) =>
