import { Image as ImageIcon, Edit, Upload, Trash2, Globe, Lock, Users } from 'lucide-react';
...
type GalleryCardAction = 'view' | 'edit' | 'upload' | 'download' | 'archive' | 'delete';
      ...
      <div className="Card_Container_Inner bg-white rounded-[14px] p-4 flex flex-col gap-4 p-10px">
        ...
        <div className="Image_Thumbnail relative w-full aspect-video rounded-[12px] overflow-hidden group/thumbnail bg-[#F7F8FA] flex items-center justify-center">
          {isUnsupportedImage(category.coverImage) ? (
            <div className="flex flex-col items-center justify-center p-4 text-center">
              ...
              <span className="text-[10px] font-bold text-[#6B7280] uppercase tracking-wider">High Efficiency Image</span>
            </div>
          ) : (
            <Image
          ...
          <div className={`Badge_Visibility absolute top-3 right-3 px-2.5 py-1.5 rounded-lg text-xs font-medium backdrop-blur-sm ${getVisibilityColor(category.visibility)}`}>
        ...
        <div className="Row_PhotoCount_Menu flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 text-sm text-[#6B7280]">
            ...
            <span className="Text_PhotoCount">{category.photoCount} photos</span>
          </div>
        ...
        {!isReadOnly && (
          <div className="Row_Buttons flex gap-2 pt-2 border-t border-[#E5E7EB]">
            ...
            <button
              ...
              <span className="text-sm font-medium text-[#374151]">Add Photos</span>
            </button>
