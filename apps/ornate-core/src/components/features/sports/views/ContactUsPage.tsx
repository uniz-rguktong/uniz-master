        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex-1">
            ...
            <p className="text-sm text-[#6B7280]">
              We&apos;re here to help you with any questions about tournaments
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={subject} onValueChange={setSubject}>
                        ...
                        <SelectContent>
                          <SelectItem value="tournament_support">
                            Tournament Support
                          </SelectItem>
                          <SelectItem value="facility_booking">
                            Facility Booking
                          </SelectItem>
            ...
            [
              {
                ...
                value: "sports.admin@college.edu",
              ...
              },
              {
                ...
                value: "Indoor Sports Complex",
                sub: "Room 101, Ground Floor",
                color: "text-[#F59E0B]",
                bg: "bg-amber-50",
              },
            ].map((item: any, i: any) => (
