        ...
        <div className="p-4 md:p-8 animate-page-entrance">
            ...
            <div className="mb-6 md:mb-8">
                <div className="flex flex-wrap items-center gap-1 md:gap-2 text-[10px] md:text-sm text-[#6B7280] mb-3">
                    ...
                    <span className="text-[#1A1A1A] font-medium whitespace-nowrap">Contact Us</span>
                </div>

                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 md:mb-8">
                    <div className="flex-1">
                        <h1 className="text-xl md:text-[28px] font-semibold text-[#1A1A1A] mb-1 md:mb-2">Get in Touch</h1>
                        <p className="text-[10px] md:text-sm text-[#6B7280]">We&apos;re here to help you with any questions about tournaments or technical support.</p>
                    </div>
                </div>
            </div>
