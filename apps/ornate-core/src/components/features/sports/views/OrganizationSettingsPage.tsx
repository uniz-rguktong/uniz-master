...
export function OrganizationSettingsPage() {
  ...
  const [formData, setFormData] = useState<any>({
    ...
    description:
      "Overseeing all inter-collegiate sports events, tournaments, and athlete development programs.",
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Configure sports council details and institutional information
            </p>
          </div>
