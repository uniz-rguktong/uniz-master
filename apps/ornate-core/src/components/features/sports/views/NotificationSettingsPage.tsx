...
const notificationCategories = [
    {
        ...
        settings: [
            { id: 'event_created', label: 'New tournament created', email: true, push: true, sms: false },
            { id: 'event_updated', label: 'Match schedule updated', email: true, push: false, sms: false },
            { id: 'new_registration', label: 'New team registration', email: true, push: true, sms: false },
            { id: 'registration_approved', label: 'Payment approved', email: true, push: false, sms: false },
            { id: 'event_reminder', label: 'Match reminders', email: true, push: true, sms: true }
        ]
    },
