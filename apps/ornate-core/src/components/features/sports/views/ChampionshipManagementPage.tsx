...
export function ChampionshipManagementPage() {
  ...
  const stats = {
    ...
    registration: championships.filter((c: any) => c.status === "registration")
      .length,
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Create and manage sports tournaments and championships
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 pb-8">
        {filteredChampionships.map((championship: any) => (
          <div
            ...
            style={{
              animationDelay: `${filteredChampionships.indexOf(championship) * 40}ms`,
            }}
          >
            {/* Header */}
            <div
            ...
            <div className="p-6">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() =>
                    showToast(
                      `Viewing details for ${championship.name}`,
                      "info",
                    )
                  }
                ...
                <button
                  onClick={() =>
                    showToast(`Edit mode for ${championship.name}`, "info")
                  }
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="League + Knockout">
                        League + Knockout
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("totalTeams", e.target.value)
                    }
