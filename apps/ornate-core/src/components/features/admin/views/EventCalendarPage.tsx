      ...
      <div className="p-4 md:p-8 animate-page-entrance">
        ...
        <div className="mb-6 md:mb-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-xl md:text-[28px] font-semibold text-[#1A1A1A] mb-2">Event Calendar</h1>
                        ...
                        <div className="flex flex-row items-start gap-4 sm:gap-6">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-wrap items-center gap-2 mb-2">
                              <h3 className="text-base sm:text-lg font-semibold text-[#1A1A1A] truncate max-w-[150px] sm:max-w-none">
                                {event.title}
                              </h3>
                              ...
                              <span
                                className="px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-semibold text-white whitespace-nowrap"
                                style={{ backgroundColor: event.categoryColor }}>
                                {event.category}
                              </span>
                            </div>
                            ...
                            <div className="mt-3 w-full sm:w-64 hidden xs:block">
                            ...
                            <div className="flex sm:hidden gap-2 mt-4">
                              <button
                                ...
                                className="flex-1 px-3 py-1.5 bg-white hover:bg-[#F3F4F6] border border-[#E5E7EB] rounded-lg text-xs font-medium text-[#1A1A1A] transition-colors">
                                View
                              </button>
                              <button
                                onClick={() => router.push(`/branch-admin/events/create?id=${event.id}`)}
                                className="flex-1 px-3 py-1.5 bg-[#1A1A1A] hover:bg-[#2D2D2D] text-white rounded-lg text-xs font-medium transition-colors">
                                Edit
                              </button>
                            </div>
                          </div>
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              ...
              <div className="pt-6 border-t border-[#E5E7EB] grid grid-cols-2 gap-3">
                <button
                  onClick={() => router.push(`/branch-admin/events/create?id=${selectedEvent.id}`)}
