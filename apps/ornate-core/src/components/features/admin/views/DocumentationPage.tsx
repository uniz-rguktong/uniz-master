...
export function DocumentationPage() {
  ...
  const docs = [
    // --- Platform Basics ---
    {
      ...
      description:
        "Understand the core layout and real-time telemetry displayed on your home screen.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            The Dashboard Ecosystem is designed for high-velocity management.
            Key features include:
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Live Telemetry:</strong> Real-time counts of total events,
              active members, and registration momentum.
            </li>
            <li>
              <strong>Visual Insights:</strong> Interactive charts showing
              registration trends over time and revenue breakdown.
            </li>
            <li>
              <strong>Flash Feed:</strong> A list of the most recent
              transactions and student check-ins across all your club's events.
            </li>
          </ul>
        </div>
      ),
    ...
    // --- Event Engineering ---
    {
      ...
      description:
        "From basic details to media assets—how to build professional-grade event pages.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-3">
            <li>
              <strong>Phase 1: Metadata:</strong> Define the name, category,
              date, and venue.
            </li>
            <li>
              <strong>Phase 2: Narrative:</strong> Add a detailed description,
              agenda, and speakers.
            </li>
            <li>
              <strong>Phase 3: Logic:</strong> Set registration rules, pricing
              tiers, and attendee capacity.
            </li>
            <li>
              <strong>Phase 4: Visuals:</strong> Upload high-res posters and
              embed promo videos.
            </li>
            <li>
              <strong>Phase 5: Governance:</strong> Review and publish or save
              as a persistent draft.
            </li>
          </ul>
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "Organize pending events and manage your club's historical event log.",
      category: "Event Engineering",
      readTime: "3 min",
      icon: FileText,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            ...
            Upcoming, and Draft events. Use Drafts to collaborate on event
            details before making them visible to the student body.
          </p>
        </div>
      ),
      questions: [
    ...
    // --- Student Lifecycle ---
    {
      ...
      description:
        "Advanced table management—filtering, sorting, and verifying thousands of entries.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <strong>Granular Filtering:</strong> Filter by year, branch,
              event, or payment status.
            </li>
            <li>
              <strong>Verification Workflow:</strong> Review payment screenshots
              and 'Approve' or 'Reject' entries.
            </li>
            <li>
              <strong>Waitlist Engine:</strong> Automatically handles overflow
              and allows manual promotion.
            </li>
          </ul>
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "Managing collaborative entries for hackathons and group competitions.",
      category: "Student Lifecycle",
      readTime: "4 min",
      icon: Heart,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            For team-based events, you can view entries grouped by Team Name.
            Manage team size limits and verify that all members have met
    ...
    },
    {
      ...
      description:
        "Real-time check-ins using the mobile scanner and digital attendance logs.",
      category: "Student Lifecycle",
      readTime: "3 min",
      icon: QrCode,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Transform your event check-ins. Launch the 'Live Attendance' module
            and scan student QR codes. The system instantly marks them as
            attended, updating your event conversion rates in real-time.
          </p>
        </div>
      ),
      questions: [
    ...
    // --- Team & Security ---
    {
      ...
      description:
        "Defining access levels for Super Admins, entities, and coordinators.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <strong>Super Admin:</strong> Full access to settings and finance.
            </li>
            <li>
              <strong>Administrative Entity:</strong> Management of events and
              data.
            </li>
            <li>
              <strong>Event Coordinator:</strong> Operational access to specific
              assigned modules.
            </li>
          </ul>
        </div>
    ...
    },
    {
      ...
      description:
        "Enrolling new team members and managing their active status.",
      category: "Team & Security",
      readTime: "3 min",
      icon: UserPlus,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Build your core team from the 'Coordinator Management' page. Assign
            roles, track their last login, and manage their access to your
            club's data.
          </p>
        </div>
      ),
    ...
    // --- Data & Analytics ---
    {
      ...
      description:
        "Synchronizing student data via CSV/Excel for external record-keeping.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            ...
            member lists or use 'Export' to generate detailed registration
            sheets in Excel format for offline analysis.
          </p>
        </div>
      ),
      questions: [
    ...
    },
    {
      ...
      description:
        "Analyzing branch-wise participation, peak traffic, and completion rates.",
      category: "Data & Analytics",
      readTime: "7 min",
      icon: TrendingUp,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Beyond basic numbers, get deep insights. See which departments are
            most active, track peak registration times, and analyze the ROI of
            your events.
          </p>
        </div>
      ),
    ...
    // --- Marketing & Comms ---
    {
      ...
      description:
        "Pushing notifications and email announcements to registered participants.",
      ...
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Communicate instantly. Use the 'Updates' module to send push
            notifications or trigger bulk emails to all students registered for
            a specific event regarding venue changes or timing updates.
          </p>
        </div>
      ),
      questions: [
    ...
    },
    {
      ...
      description:
        "Official publication of event results and managing your social media reach.",
      category: "Marketing & Comms",
      readTime: "4 min",
      icon: Trophy,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Celebrate excellence. Use the 'Winner Announcements' page to
            officially crown winners. This data is highlighted in your club's
            public profile and historical archive.
          </p>
        </div>
      ),
      questions: [
    ...
    },
    {
      ...
      description:
        "Customizing your club's visual identity and promotional media sets.",
      category: "Marketing & Comms",
      readTime: "3 min",
      icon: Video,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Keep your branding consistent. Upload your official logo and
            promotional videos that show up on the main student portal. You can
    ...
    },
    {
      ...
      description:
        "Managing your personal credentials, profile picture, and session security.",
      category: "Team & Security",
      readTime: "2 min",
      icon: Settings,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Your Admin Profile is your identity on the platform. Keep it updated
            with your official contact details and a professional profile
            picture. You can also monitor active sessions to ensure your account
            security.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      description:
        "Staying updated on platform events and configuring your communication alerts.",
      category: "Platform Basics",
      readTime: "3 min",
      icon: Bell,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            ...
            system alerts, new registration requests, and coordinator activity.
            You can customize which notifications you receive via email or push
    ...
    },
    {
      ...
      description:
        "The official path from raw entry to confirmed event participation.",
      category: "Student Lifecycle",
      readTime: "4 min",
      icon: ShieldCheck,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Maintain data integrity. Every registration starts as 'Pending'. Use
            the Workflow dashboard to verify payment proofs and eligibility
            before promoting a student to 'Confirmed' status. This ensures no
            unauthorized entries make it to your event.
          </p>
        </div>
      ),
      questions: [
...

    {
      ...
      description:
        "Building a self-service knowledge base for your student users.",
      category: "Platform Basics",
      readTime: "3 min",
      icon: HelpCircle,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Reduce support tickets by building a robust FAQ section. Address
            common queries about event participation, certificate issuance, and
            registration cycles directly on the main student portal.
          </p>
        </div>
      ),
      questions: [
    ...
    },
    {
      ...
      description:
        "Showcasing event highlights and managing your club's media heritage.",
      category: "Marketing & Comms",
      readTime: "4 min",
      icon: Image,
      content: (
        <div className="space-y-4 text-sm text-[#4B5563]">
          <p>
            Tell your club's story visually. The Gallery module allows you to
            curate high-resolution photos and videos from past events, making
            them accessible to current and prospective members to build a strong
            legacy.
          </p>
        </div>
      ),
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-[#6B7280]">
              Comprehensive guides for every module in your Club Dashboard.
            </p>
          </div>
        </div>
      </div>
