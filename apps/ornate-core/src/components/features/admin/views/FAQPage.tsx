...
export function FAQPage() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "The platform currently supports UPI, Credit/Debit Cards, and Net Banking. Our premium integration ensures that all transactions are processed securely with real-time status updates on your dashboard.",
            category: "Payment"
        },
        {
        ...
        },
        {
            ...
            answer: "The platform does not charge any additional transaction fees above the standard gateway charges. Your club receives 100% of the net amount processed through our platform.",
            category: "Payment"
        },
        {
            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex-1">
                        <h1 className="text-2xl font-bold text-[#1A1A1A] mb-2">Help & Knowledge Base</h1>
                        <p className="text-sm text-[#6B7280]">Advanced troubleshooting and dashboard administration guides.</p>
                    </div>
                </div>
            </div>
