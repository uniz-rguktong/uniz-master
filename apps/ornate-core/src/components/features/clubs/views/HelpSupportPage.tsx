        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Find answers, contact support, and check system status.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-[#F4F2F0] rounded-[18px] p-2 flex flex-col gap-2 sticky top-6">
            {tabs.map((tab: any) => {
              ...
              return (
                ...
                >
                  <Icon
                    className={`w-4 h-4 ${activeTab === tab.id ? "text-[#3B82F6]" : ""}`}
                  />
                  {tab.label}
                </button>
              );
            ...
            <div className="mt-4 p-4 bg-blue-50 rounded-xl border border-blue-100">
              ...
              <p className="text-xs text-blue-600 mb-3">
                For critical system outages, please contact the IT
                administration directly.
              </p>
              <a
                href="mailto:support@ornate-core.com"
                className="text-xs font-bold text-blue-700 hover:underline"
              >
                support@ornate-core.com
              </a>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-[20px] border border-[#E5E7EB] p-6 md:p-8 shadow-sm">
              <div className="max-w-2xl mx-auto">
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm text-[#6B7280]">
                    Describe your issue below. Our support team typically
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={idx}
                    className="bg-white rounded-[16px] border border-[#E5E7EB] p-5 shadow-sm hover:border-[#3B82F6] transition-colors group"
                  >
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-medium text-[#10B981] bg-emerald-50 px-2 py-0.5 rounded">
                        {service.status}
                      </span>
                    </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="pb-4">
                      ...
                      <div className="text-xs text-[#6B7280] mb-1">
                        Feb 10, 2026 • 02:00 AM - 04:00 AM
                      </div>
                      <p className="text-sm text-[#4B5563]">
                        Scheduled database optimization and security patching
