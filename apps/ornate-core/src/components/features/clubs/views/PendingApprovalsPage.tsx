...
export function PendingApprovalsPage({
  ...
  const [paymentsList, setPaymentsList] = useState(
    initialData.filter((r) => r.type === "payment"),
  );
  const [requirementsList, setRequirementsList] = useState(
    initialData.filter((r) => r.type === "requirements"),
  );
  ...
  const currentList =
    activeSection === "payment" ? paymentsList : requirementsList;
                  ...
                  <>
                    ...
                    <div className="bg-[#FEF2F2] border border-[#FCA5A5] rounded-lg p-4 mb-4">
                      ...
                      <ul className="space-y-1 ml-6">
                        {registration.missingRequirements?.map(
                          (req: any, i: any) => (
                            <li
                              key={i}
