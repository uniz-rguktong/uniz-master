...
interface DraftsPageProps {
  onNavigate: (route: string, payload?: Record<string, unknown>) => void;
}

export function DraftsPage({ onNavigate }: DraftsPageProps) {
  const [draftsList, setDraftsList] = useState(mockDrafts);
    ...
    <div className="p-8 animate-page-entrance">
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl md:text-[28px] font-semibold text-[#1A1A1A] mb-2">Saved Drafts</h1>
