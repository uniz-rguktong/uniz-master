...
const roles = [
  {
    ...
    name: "HHO Admin",
    description:
      "Full administrative access to all HHO modules, finances, and volunteer oversight.",
    users: 2,
    color: "#6366F1",
  ...
  },
  {
    ...
    description:
      "Operational management of charity drives, volunteer assignments, and on-ground activities.",
    users: 5,
    color: "#10B981",
  ...
  },
  {
    ...
    name: "Volunteer Lead",
    description:
      "Limited access to volunteer team management and attendance tracking for specific drives.",
    users: 12,
    color: "#F59E0B",
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-sm text-[#6B7280]">
              Manage HHO organizational roles and granular permission matrices
            </p>
          </div>
