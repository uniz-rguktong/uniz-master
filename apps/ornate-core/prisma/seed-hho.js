...
async function main() {
    ...
    const admins = JSON.parse(fs.readFileSync(path.join(backupDir, 'admins.json'), 'utf8'));
    ...
    const hhoEvents = [
        {
            ...
            description: 'Run for a cause! All proceeds from this marathon will go towards the student emergency fund.',
        ...
        },
        {
            ...
            description: 'Your blood can save a life. Join us for the campus-wide blood donation drive.',
        ...
        },
        {
            ...
            description: 'Learn basic life support and emergency first aid from professionals.',
        ...
        },
        {
            ...
            description: 'Delicious food for a great cause. Support our local community initiatives.',
    ...
    for (const eventData of hhoEvents) {
        ...
        const selectedUsers = users.sort(() => 0.5 - Math.random()).slice(0, numRegs);
