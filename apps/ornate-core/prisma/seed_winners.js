...
const studentNames = [
    'Rahul Sharma', 'Priya Patel', 'Arun Kumar', 'Sneha Reddy', 'Vikram Singh',
    'Ananya Gupta', 'Deepak Joshi', 'Kavya Nair', 'Rohan Mehta', 'Ishita Verma',
    'Arjun Das', 'Neha Kapoor', 'Siddharth Roy', 'Pooja Agarwal', 'Karthik Rajan',
    'Divya Sharma', 'Amit Desai', 'Shreya Iyer', 'Varun Malhotra', 'Ritu Saxena',
    'Manish Tiwari', 'Anjali Rao', 'Suresh Babu', 'Lakshmi Krishnan', 'Gaurav Yadav',
    'Meera Sundaram', 'Rajesh Pillai', 'Shalini Menon', 'Ajay Kulkarni', 'Nisha Jain'
];

// Project names for hackathons/competitions
const projectNames = [
    'Smart Campus Navigator', 'AI Study Assistant', 'Green Energy Monitor',
    'Virtual Lab Platform', 'Automated Attendance System', 'IoT Weather Station',
    'Blockchain Voting System', 'AR Campus Tour', 'Smart Parking Solution',
    'Health Monitoring Wristband', 'Waste Management Robot', 'Traffic Prediction ML',
    'Voice-Controlled Drone', 'Solar Tracking System', 'Water Quality Analyzer'
];

// Team name prefixes
const teamPrefixes = ['Tech', 'Code', 'Cyber', 'Digital', 'Quantum', 'Neural', 'Alpha', 'Omega', 'Phoenix', 'Spark'];
const teamSuffixes = ['Warriors', 'Innovators', 'Pioneers', 'Wizards', 'Masters', 'Titans', 'Squad', 'Force', 'Crew', 'Hub'];
...
async function main() {
    ...
    for (const event of events) {
        ...
        const positions = [];
        const prizes = ['₹10,000 + Trophy', '₹5,000 + Medal', '₹2,500 + Certificate'];
        const individualPrizes = ['Trophy + Certificate', 'Silver Medal + Certificate', 'Bronze Medal + Certificate'];
        ...
        try {
            ...
            console.log(`✅ Created winners for: ${event.title} (${event.category || 'General'})`);
            createdCount++;
        } catch (error) {
            if (error.code === 'P2002') {
