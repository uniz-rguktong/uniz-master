...
function getWinnerEmailTemplate(
  name,
  eventName,
  rank,
  verifyUrl,
...
async function resendCertificate() {
  ...
  const regWithCert = user.registrations.find(
    (r) => r.certificateUrl && r.status === "ATTENDED",
  );
