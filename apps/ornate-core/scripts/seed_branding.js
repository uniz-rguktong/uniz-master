...
async function main() {
    ...
    const videos = [
        ...
        },
        {
            ...
            url: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
            platform: "YouTube",
            thumbnail: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?w=600&h=400&fit=crop",
            status: "active",
            views: 840,
            duration: "1:30",
            creatorId: admin.id
    ...
    const logos = [
        {
            ...
            thumbnail: "https://images.unsplash.com/photo-1599305090598-fe179d501c27?w=200&h=200&fit=crop",
            status: "active",
            creatorId: admin.id
        },
        {
            ...
            thumbnail: "https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=200&h=200&fit=crop",
            status: "active",
            creatorId: admin.id
        }
    ];
