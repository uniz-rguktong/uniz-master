...
const staticRoutes = [
  ...
  { path: '/blog/best-tools-for-student-collaboration-in-india', priority: 0.7, changefreq: 'monthly' },
  { path: '/blog/how-to-manage-college-team-projects-online', priority: 0.7, changefreq: 'monthly' },
  { path: '/blog/notion-alternative-for-engineering-students', priority: 0.7, changefreq: 'monthly' },
  { path: '/blog/academic-productivity-system-guide', priority: 0.7, changefreq: 'monthly' },
];
