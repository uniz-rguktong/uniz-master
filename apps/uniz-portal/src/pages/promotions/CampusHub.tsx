      ...
      <header className="relative overflow-hidden bg-gray-100">
          ...
          >
            ...
            >
              <a
                ...
                className="px-8 py-3 bg-zinc-900 text-white font-bold rounded-xl hover:bg-black transition-all flex items-center justify-center shadow-sm"
              >
                Explore Events <ArrowRight size={16} className="ml-2" />
              </a>
              <a
                href="https://srees-campushub.vercel.app"
                className="px-8 py-3 border-2 border-zinc-200 text-zinc-600 font-bold rounded-xl hover:bg-zinc-50 transition-all flex items-center justify-center"
              >
                Learn More
              </a>
            </motion.div>
        ...
        >
          <svg width="100%" height="100%" viewBox="0 0 1000 1000">
            ...
            />
            <motion.path
              d="M100,600 Q300,400 500,600 T900,400"
              stroke="black"
              strokeWidth="40"
              fill="none"
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              CampusHub brings together all events from across your campus in
          ...
          >
            ...
            >
              ...
              <p className="text-gray-600">
                Find academic, social, cultural, and athletic events all in a
                single platform.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                Get personalized notifications about events that match your
                interests.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">
                See who's attending and connect with fellow students with
                similar interests.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            {featuresData.map((feature, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
                className="bg-white p-8 rounded-xl shadow-sm border border-zinc-100 hover:shadow-md transition-shadow"
              >
          ...
          <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                From academic lectures to sports events, clubs, and social
                gatherings - find everything that matches your interests.
              </p>
              ...
              >
                <a
                  href="https://srees-campushub.vercel.app"
                  className="inline-flex items-center px-6 py-3 bg-zinc-900 text-white font-bold rounded-xl hover:bg-black transition-all shadow-sm"
                >
            ...
            >
              ...
              <svg viewBox="0 0 800 500" className="w-full">
                ...
                >
                  ...
                  <text x="200" y="245" fill="gray" fontSize="14">
                    May 15 • Main Hall
                  </text>
                  <circle cx="550" cy="220" r="15" fill="black" />
                  <path
                    d="M545,220 L550,225 L560,215"
                    stroke="white"
                    strokeWidth="2"
                    fill="none"
                  />
                ...
                >
                  ...
                  <text x="200" y="345" fill="gray" fontSize="14">
                    May 20 • Science Building
                  </text>
                  <circle
                    cx="550"
                    cy="320"
                  ...
                  />
                  <path
                    d="M545,320 L555,320 M550,315 L550,325"
                    stroke="black"
                    strokeWidth="2"
                  />
                </motion.g>
                ...
                >
                  ...
                  <path
                    d="M80,400 Q200,300 300,400 T500,300"
                    stroke="black"
                    strokeWidth="30"
                    fill="none"
                  />
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <svg viewBox="0 0 400 300" className="w-full">
                ...
                >
                  <rect
                    ...
                    fill="#f3f4f6"
                  />
                  <text x="95" y="95" fontSize="14" fill="black">
                    Event Title
                  </text>
                  ...
                  <rect
                    ...
                    fill="#f3f4f6"
                  />
                  <text x="95" y="150" fontSize="14" fill="black">
                    Location
                  </text>
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                Easily create and promote your campus events to reach the
              ...
              >
                <motion.div variants={itemVariants} className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Reach thousands of students across campus with just a few
                      clicks.
                    </p>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Interact with attendees before, during, and after your
                      events.
                    </p>
                  </div>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Track attendance and gather feedback to improve future
                      events.
                    </p>
                  </div>
                </motion.div>
