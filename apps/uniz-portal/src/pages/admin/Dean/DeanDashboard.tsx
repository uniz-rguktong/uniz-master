...
export default function DeanDashboard() {
    ...
    const [activeTab, setActiveTab] = useState<"dashboard" | "student" | "student_bulk" | "subjects" | "attendance" | "grades" | "grades_mgmt" | "system_logs">("dashboard");
                    ...
                    <div className="p-8 space-y-8 animate-in fade-in duration-500">
                        <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
                            <div className="relative z-10">
                                <h1 className="text-4xl font-black tracking-tight mb-2">Welcome, {username}</h1>
                                <p className="text-slate-400 font-medium">Dean Control Center</p>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {navItems.slice(1).map((item) => (
                                ...
                                >
                                    ...
                                    <p className="text-xs text-slate-500 mt-1 uppercase tracking-wider font-semibold">Access Module</p>
                                </button>
                            ))}
                        </div>
                    </div>
                ...
                <header className="bg-white/80 backdrop-blur-md sticky top-0 z-40 border-b border-slate-100 p-4 px-8 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="text-right hidden sm:block">
                            ...
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Dean Academics</p>
                        </div>
