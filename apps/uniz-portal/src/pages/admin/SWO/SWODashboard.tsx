...
export default function SWODashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-[#fcfcfd] relative overflow-hidden text-slate-900 selection:bg-indigo-100 selection:text-indigo-900">
      {/* Sidebar */}
      <aside
        ...
        <header className=" sticky top-0 z-40 px-10 py-5 flex items-center justify-end bg-white/40 backdrop-blur-md border-b border-white/20">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              title="Profile"
              className="w-12 h-12 rounded-full overflow-hidden bg-slate-200 border-[3px] border-white hover:ring-2 hover:ring-indigo-400 transition-all active:scale-95 shrink-0 shadow-md ring-1 ring-slate-200/50"
            >
              {profilePhoto ? (
                <img
                  src={profilePhoto}
                ...
                <div className="w-full h-full flex items-center justify-center bg-indigo-600 text-white font-bold text-[10px] leading-tight text-center px-1 truncate">
                  {firstName}
                </div>
              )}
            </button>
