...
export default function SecurityPortal() {
  ...
  const username = localStorage.getItem("username")?.replace(/"/g, "") || "Security";
      ...
      <div className="p-6 space-y-6 animate-in fade-in duration-700 pb-20">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white p-7 rounded-3xl border border-slate-100 shadow-none transition-all hover:border-emerald-200">
            ...
            <h3 className="text-4xl font-black text-blue-600 leading-tight tracking-tight italic">
              Active
            </h3>
          </div>
        </div>
  ...
  return (
    <div className="flex min-h-screen bg-[#fcfcfd] relative overflow-hidden text-slate-900 selection:bg-emerald-100 selection:text-emerald-900">
      {/* Sidebar */}
      <aside
        ...
        <header className=" sticky top-0 z-40 px-10 py-5 flex items-center justify-end bg-white/40 backdrop-blur-md border-b border-white/20">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              title="Profile"
              className="w-12 h-12 rounded-full overflow-hidden bg-slate-200 border-[3px] border-white hover:ring-2 hover:ring-emerald-400 transition-all active:scale-95 shrink-0 shadow-md ring-1 ring-slate-200/50"
            >
              {profilePhoto ? (
                <img
                  src={profilePhoto}
                ...
                <div className="w-full h-full flex items-center justify-center bg-emerald-700 text-white font-bold text-[10px] leading-tight text-center px-1 truncate">
                  {firstName}
                </div>
              )}
            </button>
