  ...
  if (!data?.semester) {
    return (
      <div className="max-w-4xl mx-auto py-10 px-6">
        <div className="bg-zinc-50 p-12 rounded-3xl border border-dashed border-zinc-200 text-center">
    ...
    <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
      ...
      <div className="space-y-4">
        ...
        {adminData?.branches?.map((branch: any) => (
          <div
            key={branch.branch}
            className="border border-zinc-100 rounded-3xl overflow-hidden bg-white shadow-sm hover:border-zinc-200 transition-all"
          >
            <button
              onClick={() =>
                setExpandedBranch(
              ...
              className="w-full flex flex-col md:flex-row md:items-center justify-between p-6 text-left hover:bg-zinc-50/50 transition-colors"
            >
              <div className="flex items-center gap-6 mb-4 md:mb-0">
                <div className="w-14 h-14 bg-zinc-900 text-white rounded-2xl flex items-center justify-center font-semibold text-xl shadow-lg ring-4 ring-neutral-50">
                  {branch.branch}
                </div>
                <div>
            ...
            <AnimatePresence>
              {expandedBranch === branch.branch && (
                <motion.div
                  ...
                  className="bg-zinc-50/30 border-t border-zinc-50 overflow-hidden"
                >
                  <div className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {branch.subjects?.map((sub: any) => (
                        <div
                          key={sub.code}
                          className="bg-white p-4 rounded-2xl border border-zinc-100 shadow-sm flex flex-col justify-between"
                        >
                          <div>
                            ...
                            <h4 className="font-bold text-zinc-900 leading-tight mb-1">
                              {sub.name}
                            </h4>
