    ...
    <div className="p-8 space-y-10 animate-in fade-in duration-700 pb-20 text-slate-900">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-500 font-medium">
          Manage academic performance, bulk updates, and batch records.
        </p>
      </div>
              ...
              <div className="bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-sm flex flex-col md:flex-row items-end gap-6">
                <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-6 w-full text-slate-900 font-bold">
                  ...
                  <div className="space-y-2">
                    ...
                    <div
                      className="flex items-center gap-3 h-[58px] bg-slate-50 border border-slate-100 rounded-2xl px-6 cursor-pointer"
                      onClick={() =>
                        setBatchFilters({
                          ...batchFilters,
                    ...
                    >
                      <div
                        className={`w-10 h-5 rounded-full relative transition-all ${batchFilters.failedOnly ? "bg-red-400" : "bg-slate-200"}`}
                      >
                        <div
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-3 grid grid-cols-2 md:grid-cols-4 gap-6">
                          {[
                            ...
                            <div
                              key={i}
                              className="bg-white p-6 rounded-[2.5rem] border border-slate-100 flex items-center gap-5 shadow-sm hover:shadow-xl hover:translate-y-[-4px] transition-all"
                            >
                              <div
            ...
            <div className="max-w-xl mx-auto bg-white rounded-[2.5rem] border border-slate-100 p-10 space-y-8 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">
                    Add an individual grade record manually
                  </p>
                </div>
              </div>
