...
const CLOUDINARY_CLOUD = "dy2fjgt46";
const CLOUDINARY_PRESET = "uniz_upload";
                ...
                {isEditing && (
                    ...
                    >
                        {[
                            ...
                            { key: "contact", label: "Contact", icon: <Phone size={13} className="text-slate-400" /> },
                            { key: "designation", label: "Designation", icon: <Briefcase size={13} className="text-slate-400" /> },
                            { key: "department", label: "Department", icon: <Building size={13} className="text-slate-400" /> },
                        ].map(({ key, label, icon }) => (
                            <div key={key} className="flex items-center gap-3 px-3 py-2.5 bg-slate-50 rounded-xl border border-slate-100">
