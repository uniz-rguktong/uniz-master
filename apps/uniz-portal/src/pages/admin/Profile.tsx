      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-3xl border border-zinc-200 overflow-hidden shadow-sm">
          ...
          <div className="px-8 pb-12">
            <div className="relative -mt-16 mb-8 flex flex-col md:flex-row md:items-end gap-6">
              ...
              <div className="relative group">
                <div className="w-32 h-32 rounded-2xl bg-white p-1.5 shadow-xl">
                  <div className="w-full h-full rounded-2xl bg-zinc-100 flex items-center justify-center overflow-hidden relative">
                    {profile?.profile_url ? (
                      <img
                ...
                <button
                  ...
                  className="absolute bottom-2 right-2 w-10 h-10 bg-zinc-900 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-zinc-800 transition-all active:scale-90 border-4 border-white"
                >
                  <Camera size={18} />
                </button>
                <input
                  ...
                  <div className="flex items-center gap-3">
                    {isEditing ? (
                      <input
                        ...
                        className="text-3xl font-bold text-zinc-900 tracking-tight bg-zinc-50 border-b-2 border-zinc-100 focus:outline-none px-2 py-1 rounded-t-lg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-zinc-100">
              <ProfileItem
                icon={<Mail className="text-zinc-900" />}
                label="Email Address"
                value={formData.email || `${username}@rguktong.ac.in`}
                editable={false}
              />
              <ProfileItem
                icon={<User className="text-zinc-900" />}
                label="Username"
                value={username ?? ""}
              />
              <ProfileItem
              ...
              />
              <ProfileItem
                icon={<Building className="text-zinc-900" />}
                label="Department"
            ...
            <div className="mt-8 pt-8 border-t border-zinc-100">
              ...
              {isEditing ? (
                <textarea
                  ...
                  rows={4}
                  className="w-full text-sm font-medium text-zinc-600 leading-relaxed bg-zinc-50 border border-zinc-200 rounded-2xl p-4 focus:outline-none focus:border-zinc-100"
        ...
        <div className="mt-6 flex gap-4">
          <button
            ...
            className="flex-1 bg-white border border-zinc-200 p-6 rounded-2xl hover:border-zinc-100 transition-all group"
          >
...
function ProfileItem({
  ...
  return (
    <div className="flex items-start gap-4 p-4 rounded-2xl border border-zinc-50 bg-zinc-50/30">
      ...
      <div className="flex-1">
        ...
        {editable && onChange ? (
          <input
            ...
            className="text-sm font-semibold text-zinc-900 tracking-tight bg-white border border-zinc-200 rounded px-2 py-1 w-full focus:outline-none focus:border-zinc-100"
          />
        ) : (
