...
export default function FacultyDashboard() {
  ...
  const ActionCard = ({ title, subtitle, icon: Icon, onClick }: any) => (
    ...
    >
      ...
      <div className="z-10">
        <h3 className="text-lg font-bold text-neutral-900 group-hover:translate-x-1 transition-transform">
          {title}
        </h3>
        <p className="text-xs font-medium text-neutral-500 mt-1 uppercase tracking-wide group-hover:text-neutral-400">
          {subtitle}
        </p>
      </div>
    </button>
    ...
    <div className="min-h-screen bg-white text-neutral-900 pb-20">
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-12">
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl border border-neutral-100 p-8 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.05)]"
        >
          <h2 className="text-lg font-bold text-neutral-900 mb-8 flex items-center gap-2 border-b border-neutral-100 pb-4">
            <span className="w-8 h-8 rounded-lg bg-neutral-50 flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-12">
              ...
              <div className="space-y-2">
                ...
                <p className="font-medium text-neutral-900 text-lg flex items-center gap-3">
                  <span className="p-1.5 bg-neutral-50 rounded-md">
