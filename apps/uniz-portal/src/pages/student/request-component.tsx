      ...
      <div className="mb-10 mt-2 md:mt-0">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-end justify-between gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-zinc-400 font-medium text-[13px] opacity-80">
              Campus Leave Authorization Protocol
            </p>
          </div>
          <div className="text-zinc-900 flex-shrink-0 hidden md:block">
            {type === "outpass" ? (
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  className="w-full bg-zinc-50 border border-zinc-50 rounded-xl p-6 focus:border-zinc-900 focus:ring-1 focus:ring-zinc-900 focus:outline-none min-h-[160px] font-semibold text-base text-zinc-800 placeholder:text-zinc-300 placeholder:font-normal resize-none transition-all"
                />
              </div>
                  ...
                  <>
                    <div className="space-y-3">
                      ...
                      <Input
                        ...
                        className="w-full bg-zinc-50 p-4 md:p-5 rounded-xl border border-zinc-50 focus:border-zinc-900 focus:ring-1 focus:ring-zinc-900 focus:outline-none font-semibold text-base text-zinc-800 transition-all cursor-pointer"
                      />
                    </div>
                    <div className="space-y-3">
                      <label className="text-[10px] font-bold tracking-[0.14em] text-zinc-400 ml-1">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl p-8 border border-zinc-100 shadow-sm">
            <div className="flex gap-4 items-start mb-6">
              <div className="text-zinc-900 flex-shrink-0">
                <AlertCircle className="w-6 h-6" />
              </div>
              <div className="space-y-1">
                <p className="font-semibold text-zinc-900 text-sm tracking-tight">
                  Authorization Note
                </p>
          ...
          <div className="space-y-4 pb-20 md:pb-0">
            <button
              ...
              disabled={isLoading}
              className="w-full h-[58px] bg-zinc-900 hover:bg-zinc-800 text-white rounded-xl font-bold text-base transition-all active:scale-[0.98] shadow-lg shadow-zinc-100 flex items-center justify-center gap-3"
            >
              {isLoading ? (
            ...
            <button
              ...
              className="w-full h-[54px] border border-zinc-100 text-zinc-400 font-bold text-sm rounded-xl hover:bg-zinc-50 hover:text-zinc-900 transition-all flex items-center justify-center gap-2"
            >
