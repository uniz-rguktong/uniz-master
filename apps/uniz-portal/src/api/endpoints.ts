...
export const GET_REGISTRATION_SUBJECTS_TEMPLATE = `${BASE_URL}/academics/registration/subjects/template`;
...
export const RESOLVE_GRIEVANCE = (id: string) =>
  `${BASE_URL}/requests/grievance/${id}/resolve`;
