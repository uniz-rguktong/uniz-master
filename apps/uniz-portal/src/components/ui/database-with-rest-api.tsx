...
import { Bell, Megaphone, AlertCircle, Smartphone, Database, ShieldCheck, Activity } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            >
                ...
                <g stroke="currentColor" fill="none" strokeWidth="0.4" strokeDasharray="1 2" className="text-slate-300 opacity-50">
                    <path d="M 31 0 v 5" />
                    <path d="M 77 0 v 5" />
                    <path d="M 124 0 v 5" />
                    <path d="M 170 0 v 5" />
                ...
                <div className="relative z-10 flex h-[250px] w-full items-center justify-center overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-xl shadow-slate-200/50">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center gap-4 sm:gap-8 z-30 pointer-events-none px-4">
                        ...
                        >
                            ...
                            <span className="text-xs sm:text-sm font-bold text-slate-800 text-center">Core Sync</span>
                            <span className="text-[9px] sm:text-[10px] text-slate-500 text-center leading-tight mt-1">Real-time data flow</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="text-sm sm:text-base font-bold text-slate-900 text-center">API Gateway</span>
                            <span className="text-[10px] sm:text-xs text-slate-500 text-center leading-tight mt-1">Secure endpoints</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="text-xs sm:text-sm font-bold text-slate-800 text-center">Webhooks</span>
                            <span className="text-[9px] sm:text-[10px] text-slate-500 text-center leading-tight mt-1">Live metrics</span>
                        </motion.div>
                    </div>
                </div>
            </div>
